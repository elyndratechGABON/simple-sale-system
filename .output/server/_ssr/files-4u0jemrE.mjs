import { t as Capacitor } from "../_libs/capacitor__core+unenv.mjs";
import { g as getSetting, x as setSetting } from "./db-WliOSm7d.mjs";
import { n as useQuery } from "../_libs/tanstack__react-query.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/files-4u0jemrE.js
...
async function saveDocument(blob, filename) {
	if (Capacitor.isNativePlatform()) {
		const { Filesystem, Directory } = await import("../_libs/@capacitor/filesystem+[...].mjs").then((n) => n.t);
		return {
			method: "capacitor",
...
//#endregion
export { forgetDocumentsDirectory as a, pickDocumentsDirectory as c, swatchColor as d, usePreferences as f, describeSaveResult as i, saveDocument as l, applyTheme as n, getDocumentsDirectoryName as o, canPickDirectory as r, getPreferences as s, PRESET_HUES as t, savePreferences as u };
