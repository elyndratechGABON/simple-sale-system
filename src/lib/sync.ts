...
// ce module orchestre l'appel périodique et construit le payload d'agrégats.
 ...
 * 2. Si le serveur autorise la sync (« active ») et que le dernier envoi date de plus de
