...
var x = class extends h {
  ...
  setOptions(e) {
    ...
    if (
      ...
      this.options.enabled !== void 0 &&
        ...
        typeof r(this.options.enabled, this.#t) != `boolean`)
    )
    ...
    (i && T(this.#t, n, this.options, t) && this.#h(),
      this.updateResult(),
      i &&
        (this.#t !== n ||
          r(this.options.enabled, this.#t) !== r(t.enabled, this.#t) ||
  ...
  #g() {
    ...
    if (_.isServer() || this.#r.isStale || !u(e)) return;
    let t = o(this.#r.dataUpdatedAt, e) + 1;
    this.#d = g.setTimeout(() => {
  ...
  #v(e) {
    (this.#x(),
      (this.#p = e),
      !(_.isServer() || r(this.options.enabled, this.#t) === !1 || !u(this.#p) || this.#p === 0) &&
        (this.#f = g.setInterval(() => {
          (this.options.refetchIntervalInBackground || n.isFocused()) && this.#h();
        }, this.#p)));
  }
  #y() {
  ...
  createResult(e, t) {
    ...
    let { error: h, errorUpdatedAt: g, status: _ } = d;
    p = d.data;
    let y = !1;
      ...
      (a?.isPlaceholderData && t.placeholderData === s?.placeholderData
        ...
        : (e =
            typeof t.placeholderData == `function`
              ...
              : t.placeholderData),
        e !== void 0 && ((_ = `success`), (p = c(a?.data, e, t)), (f = !0)));
    }
    ...
    this.#s && ((h = this.#s), (p = this.#l), (g = Date.now()), (_ = `error`));
...
function S(e, t) {
  return (
    r(t.enabled, e) !== !1 &&
    e.state.data === void 0 &&
    !(e.state.status === `error` && r(t.retryOnMount, e) === !1)
  );
}
function C(e, t) {
...
function w(e, t, n) {
  if (r(t.enabled, e) !== !1 && b(t.staleTime, e) !== `static`) {
...
function T(e, t, n, i) {
  return (
    (e !== t || r(i.enabled, e) === !1) && (!n.suspense || e.state.status !== `error`) && ee(e, n)
  );
}
function ee(e, t) {
  return r(t.enabled, e) !== !1 && e.isStaleByTime(b(t.staleTime, e));
}
function te(e, t) {
...
var ae = D.createContext(ie()),
  ...
  k = ({ result: e, errorResetBoundary: t, throwOnError: n, query: r, suspense: a }) =>
    e.isError &&
    !t.isReset() &&
    !e.isFetching &&
    r &&
  ...
  le = (e, t) => e.isLoading && e.isFetching && !t,
  ue = (e, t) => e?.suspense && t.isPending,
  de = (e, t, n) =>
...
function fe(e, t, n) {
  ...
  let l = !a.getQueryCache().get(o.queryHash),
    [u] = D.useState(() => new t(a, o)),
    m = u.getOptimisticResult(o),
    h = !r && c;
  if (
    (D.useSyncExternalStore(
      D.useCallback(
        (e) => {
          let t = h ? u.subscribe(p.batchCalls(e)) : f;
  ...
  return (
    ...
    o.experimental_prefetchInRender &&
      !_.isServer() &&
      le(m, r) &&
      (l ? de(o, u, i) : s?.promise)?.catch(f).finally(() => {
        u.updateResult();
      }),
    o.notifyOnChangeProps ? m : u.trackResult(m)
  );
}
function pe(e, t) {
  return fe(e, x, t);
      ...
      ((n, r) => {
        typeof e == `object` && t !== void 0
          ...
          : typeof define == `function` && define.amd
            ? define(r)
            : ((n = typeof globalThis < `u` ? globalThis : n || self).Dexie = r());
      })(e, function () {
        var e = function (t, n) {
            return (e =
        ...
        function n(e, t, n) {
          if (n || arguments.length === 2)
            for (var r, i = 0, a = t.length; i < a; i++)
              (!r && i in t) || ((r ||= Array.prototype.slice.call(t, 0, i))[i] = t[i]);
        ...
        function u(e, t) {
          (typeof t == `function` && (t = t(s(e))),
            (typeof Reflect > `u` ? i : Reflect.ownKeys)(t).forEach(function (n) {
              f(e, n, t[n]);
            }));
        }
          ...
          return (
            ...
            (e = (function e(t) {
              ...
              if (a(t)) {
                ...
                var o,
                  c = s(t);
                for (o in ((n = c === Object.prototype ? {} : Object.create(c)), te.set(t, n), t))
                  l(t, o) && (n[o] = e(t[o]));
              }
              return n;
            })(e)),
        ...
        var re = typeof Symbol < `u` ? Symbol.iterator : `@@iterator`,
          ie =
            typeof re == `symbol`
              ? function (e) {
                  var t;
...
`)
        ...
        function fe(e, t) {
          ((this.name = `BulkError`),
            ...
            (this.message = ue(e, this.failures)));
        }
        (p(le)
          .from(Error)
          .extend({
 ...
 ` + r
                  ...
                  : ((this.message = ce[t] || n), (this.inner = null)));
            }
          ...
          return e === j
            ...
            : function () {
                var n = e.apply(this, arguments),
                  ...
                  i = this.onerror,
                  a = ((this.onsuccess = null), (this.onerror = null), t.apply(this, arguments));
                return (
                  r && (this.onsuccess = this.onsuccess ? ve(r, this.onsuccess) : r),
                  i && (this.onerror = this.onerror ? ve(i, this.onerror) : i),
                  a === void 0 ? n : a
                );
              };
        }
          ...
          return e === j
            ...
            : function () {
                ...
                ((this.onsuccess = this.onerror = null),
                  ...
                  n && (this.onsuccess = this.onsuccess ? ve(n, this.onsuccess) : n),
                  r && (this.onerror = this.onerror ? ve(r, this.onerror) : r));
              };
        }
        function xe(e, t) {
          return e === j
        ...
        ((T.ModifyError = de), (T.DexieError = le), (T.BulkError = fe));
        var M =
            ...
            typeof Promise > `u`
              ...
              : ((k = Promise.resolve()),
                typeof crypto < `u` && crypto.subtle
                  ? [(De = crypto.subtle.digest(`SHA-512`, new Uint8Array([0]))), s(De), k]
                  : [k, s(k), k]),
          k = De[0],
          N = De[1],
          N = N && N.then,
        ...
        function L(e) {
          ...
          if (typeof e != `function`) {
            ...
            ((this._state = arguments[1]),
              ...
              !1 === this._state && Be(this, this._value));
          } else
            ((this._state = null),
              (this._value = null),
              ++t.ref,
              ...
              t._state ||
                ...
                ((e) => {
                  for (var t = Me.length; t;)
                    if (Me[--t]._value === e._value) return Me.splice(t, 1);
                })(t),
              n.resolve(r));
          } catch (e) {
            n.reject(e);
        ...
        function R(e, t) {
          ...
          return function () {
            var r = Ge(),
              i = I;
            try {
              return (V(n, !0), e.apply(this, arguments));
            } catch (e) {
              t && t(e);
            } finally {
              (V(i, !1), r && Ke());
        ...
        (u(L.prototype, {
          ...
          typeof Symbol < `u` &&
            Symbol.toStringTag &&
            f(L.prototype, Symbol.toStringTag, `Dexie.Promise`),
          (F.env = it()),
          u(L, {
            all: function () {
              var e = O.apply(null, arguments).map(nt);
          ...
          P &&
            ...
            P.withResolvers) &&
            (L.withResolvers = P.withResolvers));
          ...
          var i = I,
            ...
            t =
              ...
              (a.env = Oe
                ? {
                    Promise: L,
                    PromiseProp: { value: L, configurable: !0, writable: !0 },
                    all: L.all,
                    race: L.race,
        ...
        function nt(e) {
          return z.echoes && e && e.constructor === P
            ? (tt(),
              e.then(
                function (e) {
                  return (B(), e);
        ...
        function V(e, t) {
          var n,
            i,
            a = I;
          ((t ? !z.echoes || (Ze++ && e === I) : !Ze || (--Ze && e === I)) ||
            queueMicrotask(
              t
                ? function (e) {
                    (++Qe,
                      (z.echoes && --z.echoes != 0) || (z.echoes = z.awaits = z.id = 0),
                      Xe.push(I),
                      V(e, !0));
                  }.bind(null, e)
                : rt,
            ...
            e !== I &&
              ((I = e), a === F && (F.env = it()), Oe) &&
              ((n = F.env.Promise), (i = e.env), a.global || e.global) &&
          ...
          return typeof e == `function`
            ? function () {
                ...
                try {
                  ...
                  (V(i, !1), r && queueMicrotask(B));
                }
              }
            : e;
        }
        function st(e) {
          Promise === P && z.echoes === 0
            ? Ze === 0
              ? e()
              : enqueueNativeMicroTask(e)
            : setTimeout(e, 0);
        }
        (`` + N).indexOf(`[native code]`) === -1 && (tt = B = j);
        var H = L.reject,
          ct = `￿`,
          U = `Invalid key provided. Keys must be of type string, number, Date or Array<string | number | Date>.`,
          lt = `String expected.`,
          ut = `__dbnames`,
          dt = `readonly`,
          ft = `readwrite`;
        ...
        var mt = { type: 3, lower: -1 / 0, lowerOpen: !1, upper: [[]], upperOpen: !1 };
        function ht(e) {
        ...
        function W(e, t) {
          try {
            ...
            switch (n) {
              ...
              case `binary`:
                for (
                  var i = vt(e), a = vt(t), o = i.length, s = a.length, c = o < s ? o : s, l = 0;
                  l < c;
                  ++l
                )
              ...
              case `Array`:
                for (
                  var u = e, d = t, f = u.length, p = d.length, m = f < p ? f : p, h = 0;
                  h < m;
                  ++h
                ) {
                  var g = W(u[h], d[h]);
        ...
        function _t(e) {
          var t = typeof e;
          return t == `object` && (ArrayBuffer.isView(e) || (t = ne(e)) === `ArrayBuffer`)
            ? `binary`
            : t;
        }
        function vt(e) {
            ...
            ? (t &&
              ...
              Promise.all(
                r.map(function (n) {
                  return (
                    (n = n.updatesTable),
                    t ? e.db.table(n).where(`k`).anyOf(t).delete() : e.db.table(n).clear()
                  );
                }),
              ).then(function () {
                return n;
        ...
        function St(e, t) {
          for (var n = i(t), r = n.length, a = !1, o = 0; o < r; ++o) {
            var s = n[o],
              c = t[s],
              l = b(e, s);
            c instanceof bt ? (x(e, s, c.execute(l)), (a = !0)) : l !== c && (x(e, s, c), (a = !0));
          }
          return a;
        }
        ((G.prototype._trans = function (e, t, n) {
          var r = this._tx || I.trans,
            ...
            a =
              ...
              typeof console < `u` &&
              console.createTask &&
              console.createTask(`Dexie: ${e === `readonly` ? `read` : `write`} ${this.name}`);
          function o(e, n, r) {
            if (r.schema[i]) return t(r.idbtrans, r);
            throw new A.NotFound(`Table ` + i + ` not part of transaction`);
          }
          var s = Ge();
          try {
            var c =
              r && r.db._novip === this.db._novip
                ? r === I.trans
                  ...
                  : et(
                      ...
                      { trans: r, transless: I.transless || I },
                    )
                : (function e(t, n, r, i) {
                    ...
                    if (t._state.openComplete) return H(new A.DatabaseClosed(t._state.dbOpenError));
                    if (!t._state.isBeingOpened) {
                      if (!t._state.autoOpen) return H(new A.DatabaseClosed());
                      t.open().catch(j);
                    }
          ...
          (G.prototype.get = function (e, t) {
            ...
            return e && e.constructor === Object
              ...
              : e == null
                ? H(new A.Type(`Invalid argument to Table.get()`))
          ...
          (G.prototype.mapToClass = function (t) {
            for (
              var n = this.db,
                r = this.name,
                i =
                  ((this.schema.mappedClass = t).prototype instanceof gt &&
                    (t = ((t) => {
                      var i = s,
                        a = t;
              ...
              return n.core.get({ trans: i, key: e }).then(function (a) {
                ...
                return (
                  ...
                  n.core
                    ...
                    .then(function (e) {
                      return e.numFailures ? L.reject(e.failures[0]) : !!a;
                    })
                );
              });
            });
          ...
          (G.prototype.update = function (e, t) {
            return typeof e != `object` || a(e)
              ...
              : (e = b(e, this.schema.primKey.keyPath)) === void 0
                ? H(new A.InvalidArgument(`Given object does not contain its primary key`))
                : this.where(`:id`).equals(e).modify(t);
          }),
          ...
          (G.prototype.clear = function () {
            ...
            return this._trans(`readwrite`, function (t) {
              return e.core.mutate({ trans: t, type: `deleteRange`, range: mt }).then(function (t) {
                return yt(e, null, t);
              });
            }).then(function (e) {
              return e.numFailures ? L.reject(e.failures[0]) : void 0;
          ...
          (G.prototype.bulkAdd = function (e, t, n) {
            ...
            return this._trans(`readwrite`, function (t) {
              ...
              if (i && i.length !== e.length)
                throw new A.InvalidArgument(`Arguments objects and keys must have the same length`);
              var s = e.length,
                o = n && o ? e.map(ht(n)) : e;
              return r.core
                .mutate({ trans: t, type: `add`, keys: i, values: o, wantResults: a })
                .then(function (e) {
                  var t = e.numFailures,
                    n = e.failures;
                  if (t === 0) return a ? e.results : e.lastResult;
                  throw new fe(`${r.name}.bulkAdd(): ${t} of ${s} operations failed`, n);
                });
            });
          }),
          (G.prototype.bulkPut = function (e, t, n) {
            ...
            return this._trans(`readwrite`, function (t) {
              ...
              var s = e.length,
                o = n && o ? e.map(ht(n)) : e;
              return r.core
                .mutate({ trans: t, type: `put`, keys: i, values: o, wantResults: a })
                .then(function (e) {
                  var t = e.numFailures,
                    n = e.failures;
                  if (t === 0) return a ? e.results : e.lastResult;
                  throw new fe(`${r.name}.bulkPut(): ${t} of ${s} operations failed`, n);
                });
            });
          }),
                      ...
                      if (o) {
                        for (var u = 0, d = Object.keys(i); u < d.length; u++) {
                          ...
                          if (f === t.schema.primKey.keyPath) {
                            if (W(p, r) !== 0)
                              throw new A.Constraint(`Cannot update primary key in bulkUpdate()`);
                          } else x(o, f, p);
                        }
          ...
          (G.prototype.bulkDelete = function (e) {
            var t = this,
              n = e.length;
            return this._trans(`readwrite`, function (n) {
              return t.core.mutate({ trans: n, type: `delete`, keys: e }).then(function (n) {
                return yt(t, e, n);
              });
            }).then(function (e) {
              var r = e.numFailures,
              ...
              throw new fe(`${t.name}.bulkDelete(): ${r} of ${n} operations failed`, i);
            });
          }));
        var Ct = G;
        function G() {}
        ...
        function jt(e, t, n, r) {
          var i,
            a,
            o = e.replayFilter ? pt(e.filter, e.replayFilter()) : e.filter;
          return e.or
            ? ((i = {}),
              (a = function (e, n, r) {
                var a, s;
              ...
              Promise.all([
                e.or._iterate(a, n),
                Mt(At(e, r, n), e.algorithm, a, !e.keysOnly && e.valueMapper),
              ]))
            : Mt(At(e, r, n), pt(e.algorithm, o), t, !e.keysOnly && e.valueMapper);
        }
        function Mt(e, t, n, r) {
          var i = R(
            r
        ...
        ((K.prototype._read = function (e, t) {
          var n = this._ctx;
          return n.error
            ? n.table._trans(null, H.bind(null, n.error))
            : n.table._trans(`readonly`, e).then(t);
        }),
          (K.prototype._write = function (e) {
            var t = this._ctx;
            return t.error
              ? t.table._trans(null, H.bind(null, t.error))
          ...
          (K.prototype.count = function (e) {
            ...
            return this._read(function (e) {
              ...
              return Et(r, !0)
                ? i
                    .count({ trans: e, query: { index: kt(r, i.schema), range: r.range } })
                    .then(function (e) {
          ...
          (K.prototype.toArray = function (e) {
            ...
            return this._read(function (e) {
              var n,
                ...
                i,
                a = t._ctx;
              return Et(a, !0) && 0 < a.limit
                ? ((n = a.valueMapper),
                  (r = kt(a, a.table.core.schema)),
                  a.table.core
                    .query({
                      trans: e,
                      limit: a.limit,
          ...
          (K.prototype.filter = function (e) {
            var t;
            return (
              Dt(this._ctx, function (t) {
                return e(t.value);
              }),
              ((t = this._ctx).isMatch = pt(t.isMatch, e)),
              this
            );
          }),
          ...
          (K.prototype.modify = function (e) {
            ...
            return this._write(function (r) {
              ...
              var o =
                ...
                f = (c && (d = typeof c == `object` ? c[s.name] || c[`*`] || 200 : c), []),
                p = 0,
                m = [],
                h = e === Pt;
              return t
                ...
                .then(function (t) {
                  function i(f) {
                    var p = Math.min(d, t.length - f),
                      m = t.slice(f, f + p);
                    return (
                      h ? Promise.resolve([]) : s.getMany({ trans: r, keys: m, cache: `immutable` })
                    ).then(function (g) {
                      var _ = [],
                        v = [],
                        y = l ? [] : null,
                      ...
                      return Promise.resolve(
                        0 < _.length &&
                          s.mutate({ trans: r, type: `add`, values: _ }).then(function (e) {
                  ...
                  var c = Et(n) &&
                    n.limit === 1 / 0 &&
                    (typeof e != `function` || h) && { index: n.index, range: n.range };
                  return i(0).then(function () {
                    if (0 < f.length) throw new de(`Error modifying one or more objects`, f, p, m);
                    return t.length;
                  });
                });
            });
          ...
          (K.prototype.delete = function () {
            var e = this._ctx,
              t = e.range;
            return !Et(e) || e.table.schema.yProps || (!e.isPrimKey && t.type !== 3)
              ? this.modify(Pt)
        ...
        function q(e, t, n) {
          return (
            (e = e instanceof Vt ? new e.Collection(e) : e),
        ...
        var Ut = `storagemutated`,
          Wt = `x-storagemutated-1`,
          Gt = wt(null, Ut),
          Kt =
            ((X.prototype._lock = function () {
              return (
                v(!I.global),
                ++this._reculock,
                this._reculock !== 1 || I.global || (I.lockOwnerFor = this),
                this
              );
            }),
            (X.prototype._unlock = function () {
              if ((v(!I.global), --this._reculock == 0))
                for (
                  I.global || (I.lockOwnerFor = null);
            ...
            (X.prototype.create = function (e) {
              ...
              if (this.mode) {
                ...
                (v(this._completion._state === null),
                  ((e = this.idbtrans =
                    e ||
                    (this.db.core || n).transaction(this.storeNames, this.mode, {
                      durability: this.chromeTransactionDurability,
                    })).onerror = R(function (n) {
                    (Ht(n), t._reject(e.error));
                  })),
                  (e.onabort = R(function (n) {
                    (Ht(n),
                      t.active && t._reject(new A.Abort(e.error)),
                      (t.active = !1),
                      t.on(`abort`).fire(n));
                  })),
                  (e.oncomplete = R(function () {
                    ((t.active = !1),
                      t._resolve(),
                      `mutatedParts` in e && Gt.storagemutated.fire(e.mutatedParts));
                  })));
              }
              return this;
            }),
            (X.prototype._promise = function (e, t, n) {
              ...
              return e === `readwrite` && this.mode !== `readwrite`
                ? H(new A.ReadOnly(`Transaction is readonly`))
                : this.active
                  ? this._locked()
                    ? new L(function (r, a) {
            ...
            (X.prototype.table = function (e) {
              ...
              if (n)
                return (
                  ((n = new this.db.Table(e, n, this)).core = this.db.core.table(e)),
                  (t[e] = n)
                );
              ...
              mutate: function (e) {
                ...
                return new Promise(function (e, c) {
                  ...
                  if (a && o && a.length !== o.length)
                    throw Error(`Given keys array must have same length as given values array.`);
                  if (p === 0)
                    return e({ numFailures: 0, failures: {}, results: [], lastResult: void 0 });
                  function m(e) {
                    (++_, Ht(e));
                  }
                  var h = [],
                  ...
                  if (n === `deleteRange`) {
                    if (s.type === 4)
                      return e({ numFailures: _, failures: g, results: [], lastResult: void 0 });
                    ...
                    if (d)
                      for (var b = 0; b < p; ++b)
                        (h.push((f = y && y[b] !== void 0 ? l[n](v[b], y[b]) : l[n](v[b]))),
                          (f.onerror = m));
              ...
              getMany: function (e) {
                ...
                return new Promise(function (e, r) {
                  ...
                  for (
                    ...
                    n[p] != null &&
                      (((a = o.get(n[p]))._pos = p), (a.onsuccess = d), (a.onerror = f), ++l);
                  l === 0 && e(c);
                });
              },
              get: function (e) {
                  ...
                  return new Promise(function (a, o) {
                    ...
                    n
                      ? ((m = { query: _, count: g, direction: h }),
                        ...
                        (s.onerror = Y(o)))
                      : t && h === `next`
                        ? (((s = f ? d.getAll(_, g) : d.getAllKeys(_, g)).onsuccess = function (e) {
                            return a({ result: e.target.result });
                          }),
                          (s.onerror = Y(o)))
                        : ((c = 0),
                          ...
                          (l.onsuccess = function () {
                            var e = l.result;
                            return !e || (u.push(f ? e.value : e.primaryKey), ++c === p)
                              ? a({ result: u })
                              : void e.continue();
                          }),
                          (l.onerror = Y(o)));
              ...
              openCursor: function (e) {
                ...
                return new Promise(function (e, c) {
                  ...
                  var l = a.index,
                    ...
                    l = o ? (s ? `prevunique` : `prev`) : s ? `nextunique` : `next`,
                    f =
                      !n && `openKeyCursor` in d ? d.openKeyCursor(r(u), l) : d.openCursor(r(u), l);
                  ((f.onerror = Y(c)),
                    (f.onsuccess = R(function (n) {
                      var r,
                        i,
                        a,
                        o,
        ...
        function rn(e, t) {
          var n = t.db,
            n = nn(e._middlewares, n, e._deps, t);
          ((e.core = n.dbcore),
                      ...
                      : (t.forEach(function (e) {
                          (l.push(function () {
                            var t,
                              ...
                              l = u,
                              d = e._cfg.dbschema,
                              f = (hn(r, l, c), hn(r, d, c), (u = r._dbSchema = d), un(l, d)),
                              p =
                            ...
                            if (p && e._cfg.version > a)
                              return (
                                ...
                                an(r, [r.Transaction.prototype], i(t), t),
                                (s.schema = t),
                                (n = se(p)) && tt(),
                                (d = L.follow(function () {
                                  var e;
                                  (o = p(s)) && n && ((e = B.bind(null, null)), o.then(e, e));
                                })),
                            ...
                            l.push(function (t) {
                              ...
                              ([].slice.call(i.db.objectStoreNames).forEach(function (e) {
                                ...
                                on(r, [r.Transaction.prototype]),
                                an(r, [r.Transaction.prototype], r._storeNames, r._dbSchema),
                                (s.schema = r._dbSchema));
                            }),
                            l.push(function (t) {
                              r.idbdb.objectStoreNames.contains(`$meta`) &&
                                (Math.ceil(r.idbdb.version / 10) === e._cfg.version
                                  ? (r.idbdb.deleteObjectStore(`$meta`),
                                    delete r._dbSchema.$meta,
                                    (r._storeNames = r._storeNames.filter(function (e) {
                                      return e !== `$meta`;
                                    })))
        ...
        function ln(e, t) {
          (fn(e._dbSchema, t),
            t.db.version % 10 != 0 ||
              ...
              t.db.createObjectStore(`$meta`).add(Math.ceil(t.db.version / 10 - 1), `version`));
          ...
          for (var r = 0, i = un(n, e._dbSchema).change; r < i.length; r++) {
            var a = ((e) => {
              ...
              e.add.forEach(function (t) {
                (M &&
                  console.debug(`Dexie upgrade patch: Creating missing index ${e.name}.${t.src}`),
                  pn(n, t));
              });
            })(i[r]);
        ...
        function fn(e, t) {
          i(e).forEach(function (n) {
            t.db.objectStoreNames.contains(n) ||
              (M && console.debug(`Dexie: Creating missing table`, n),
              dn(t, n, e[n].primKey, e[n].indexes));
          });
        }
        function pn(e, t) {
            ...
            g(t.objectStoreNames, 0).forEach(function (e) {
              for (
                ...
                var s = t.index(t.indexNames[o]),
                  c = s.keyPath,
                  s = qt(s.name, c, !!s.unique, !!s.multiEntry, !1, c && typeof c != `string`, !1);
                a.push(s);
              }
              r[e] = Yt(e, i, a);
            }),
        ...
        function hn(e, t, n) {
          for (var i = n.db.objectStoreNames, a = 0; a < i.length; ++a) {
            ...
            for (var c = 0; c < s.indexNames.length; ++c) {
              ...
              t[o] &&
                (l = t[o].idxByName[d]) &&
                ((l.name = u), delete t[o].idxByName[d], (t[o].idxByName[u] = l));
            }
          }
          typeof navigator < `u` &&
            /Safari/.test(navigator.userAgent) &&
        ...
        ((vn.prototype._createTableSchema = Yt),
          (vn.prototype._parseIndexSyntax = gn),
          (vn.prototype._parseStoresSpec = function (e, t) {
            var n = this;
          ...
          (vn.prototype.stores = function (e) {
            ...
            return (
              ...
              an(t, [t._allTables, t, t.Transaction.prototype, this._cfg.tables], i(r), r),
              (t._storeNames = i(r)),
              this
            );
          }),
          (vn.prototype.upgrade = function (e) {
            return ((this._cfg.contentUpgrade = Ce(this._cfg.contentUpgrade || j, e)), this);
          }));
        var _n = vn;
        function vn() {}
        var yn = (() => {
                ...
                add: function (n) {
                  ...
                  (e.add(r),
                    ...
                    e.size > n._options.maxConnections &&
                      ((r = e.values().next().value), e.delete(r), t.unregister(r)));
                },
                remove: function (n) {
                  if (n)
        ...
        function bn(e, t) {
          ...
          return (
            n ||
              (n = e._dbNamesDB = new Q(ut, { addons: [], indexedDB: e, IDBKeyRange: t }))
                .version(1)
                .stores({ dbnames: `name` }),
            n.table(`dbnames`)
          );
        ...
        var Z = function (e, t) {
          ...
          o(
            this,
            arguments.length ? { d: 1, from: e, to: 1 < arguments.length ? t : e } : { d: 0 },
          );
        };
        function wn(e, t, n) {
          var r = W(t, n);
          if (!isNaN(r)) {
            ...
            if (Cn(e)) return o(e, { from: t, to: n, d: 1 });
            var r = e.l,
              i = e.r;
            if (W(n, e.from) < 0)
              return (r ? wn(r, t, n) : (e.l = { from: t, to: n, d: 1, l: null, r: null }), On(e));
            if (0 < W(t, e.to))
              return (i ? wn(i, t, n) : (e.r = { from: t, to: n, d: 1, l: null, r: null }), On(e));
            (W(t, e.from) < 0 && ((e.from = t), (e.l = null), (e.d = i ? i.d + 1 : 1)),
              0 < W(n, e.to) && ((e.to = n), (e.r = null), (e.d = e.l ? e.l.d + 1 : 1)),
              (t = !e.r),
              r && !e.l && Tn(e, r),
              i && t && Tn(e, i));
          }
            ...
            next: function (e) {
              for (var n = 0 < arguments.length; t;)
                switch (t.s) {
                  case 0:
                    if (((t.s = 1), n))
                      for (; t.n.l && W(e, t.n.from) < 0;) t = { up: t, n: t.n.l, s: 1 };
                    else for (; t.n.l;) t = { up: t, n: t.n.l, s: 1 };
                  case 1:
                    if (((t.s = 2), !n || W(e, t.n.to) <= 0)) return { value: t.n, done: !1 };
                  case 2:
                    if (t.n.r) {
              ...
              e[n]
                ...
                : (e[n] = (function e(t) {
                    ...
                    for (n in t)
                      l(t, n) &&
                        ((r = t[n]),
                        (i[n] = !r || typeof r != `object` || ee.has(r.constructor) ? r : e(r)));
                    return i;
                  })(t[n]));
            }),
            e
        ...
        function In(e, t) {
          ...
          var n = new Set();
          if (e.all)
            for (var r = 0, i = Object.values(Mn); r < i.length; r++) Ln((s = i[r]), e, n, t);
          else
            for (var a in e) {
              var o,
                s,
        ...
        function Rn(e) {
          ...
          function c() {
            return new L(function (r, l) {
              ...
              ((p.onerror = Y(l)),
                (p.onblocked = R(e._fireOnBlocked)),
                (p.onupgradeneeded = R(function (r) {
                  var i;
                  ((d = p.transaction),
                ...
                (p.onsuccess = R(function () {
                    ...
                    try {
                      ...
                      if (t.autoSchema)
                        ((_ = v),
                          ...
                          (m = l._dbSchema = mn(0, _, m)),
                          (l._storeNames = g(_.objectStoreNames, 0)),
                          an(l, [l._allTables], i(m), m));
                      else if (
                        (hn(e, e._dbSchema, b),
                        (s = b),
                        ((s = un(mn(0, (n = e).idbdb, s), n._dbSchema)).add.length ||
                  ...
                  (yn.add(e),
                    (v.onversionchange = R(function (n) {
                      ((t.vcFired = !0), e.on(`versionchange`).fire(n));
                    })),
                    (v.onclose = R(function () {
                    ...
                    f &&
                      ...
                      xn((_ = y.indexedDB)) ||
                        h === ut ||
                        bn(_, y.IDBKeyRange).put({ name: h }).catch(j)),
                    r());
                }, l)));
            }).catch(function (e) {
              switch (e?.name) {
              ...
              return (
                ...
                L.resolve(
                  ...
                  if (0 < t.onReadyBeingFired.length)
                    return (
                      (r = t.onReadyBeingFired.reduce(Ce, j)),
                      (t.onReadyBeingFired = []),
                      L.resolve(
                        Sn(function () {
                          return r(e.vip);
                ...
                f &&
                  ...
                  e.tables.forEach(function (n) {
                    (n.schema.indexes.forEach(function (r) {
                      ...
                      (t[`idb://${e.name}/${n.name}/`] = t[`idb://${e.name}/${n.name}/:dels`] =
                        new Z(-1 / 0, [[[]]])));
                  }),
                  Gt(Ut).fire(t),
                  In(t, !0)),
                        ...
                        continue: {
                          value: function (r) {
                            r == null
                              ? t.unique
                                ? n.continue(
                                    n.key.slice(0, a).concat(t.reverse ? e.MIN_KEY : e.MAX_KEY, i),
                                  )
                                : n.continue()
                              : n.continue(Bn(r, t.reverse ? e.MAX_KEY : e.MIN_KEY, i));
                          },
                        },
                        continuePrimaryKey: {
                          value: function (t, r) {
                          ...
                          function () {
                            return (function e(n, r, o) {
                              return i
                                ...
                                .then(function (i) {
                                  var a = i.result;
                                  return f({ type: `delete`, keys: a, trans: n }).then(
                                    function (i) {
                        ...
                        return (
                          (e =
                            e.type === `add` || e.type === `put`
                              ? t(t({}, e), { keys: p })
                              : t({}, e)).type !== `delete` && (e.values = n([], e.values, !0)),
                          (e.keys &&= n([], e.keys, !0)),
                          (r = i),
                          (s = p),
                          ((o = e).type === `add`
                            ? Promise.resolve([])
                            : r.getMany({ trans: o.trans, keys: s, cache: `immutable` })
                          ).then(function (t) {
                                  ...
                                  : e.type === `add` || p === void 0
                                    ? ((i = u.fire.call(m, n, e.values[r], f)),
                                      n == null &&
                                        i != null &&
                                        ((e.keys[r] = n = i),
                                        a.outbound || x(e.values[r], a.keyPath, n)))
                                    : ((i = Hn(p, e.values[r])),
                              ...
                              .then(function (r) {
                                for (
                                  ...
                                  c == null
                                    ...
                                    : l.onsuccess &&
                                      l.onsuccess(e.type === `put` && t[s] ? e.values[s] : c);
                                }
                                return { failures: i, results: a, numFailures: o, lastResult: r };
                              })
                              .catch(function (e) {
                                return (
        ...
        function Gn(e, t, n) {
          try {
            ...
            for (var r = [], i = 0, a = 0; i < t.keys.length && a < e.length; ++i)
              W(t.keys[i], e[a]) === 0 && (r.push(n ? E(t.values[i]) : t.values[i]), ++a);
              ...
              table: function (n) {
                ...
                return t(t({}, r), {
                  getMany: function (e) {
                    var t;
                    return e.cache
                      ? (t = Gn(e.keys, e.trans._cache, e.cache === `clone`))
                        ? L.resolve(t)
        ...
        var Yn = {
          ...
          create: function (e) {
            var n = e.schema.name,
              r = new Z(e.MIN_KEY, e.MAX_KEY);
            return t(t({}, e), {
              transaction: function (t, n, r) {
                if (I.subscr && n !== `readonly`)
                  throw new A.ReadOnly(
                    `Readwrite transaction in liveQuery context. Querier source: ${I.querier}`,
                  );
                  ...
                  h = t(t({}, c), {
                    mutate: function (t) {
                      ...
                      return (
                        a(b)
                          ? (g.addKeys(b),
                            (v = v === `delete` || b.length === y.length ? Gn(b, x) : null) ||
                              _.addKeys(b),
                            (v || y) &&
                              ((s = i),
                              (d = v),
                        ...
                        c.mutate(t).then(function (e) {
                          return (
                            ...
                            (p.mutatedParts = An(p.mutatedParts || {}, h)),
                            e
                          );
                        })
                      );
                    ...
                    h[e] = function (i) {
                      ...
                      if (s) {
                        var u,
                          ...
                          s = s[1];
                        if (
                          ((e === `query` && h.isPrimaryKey && !i.values ? m : a(h.name || ``)).add(
                            s,
                          ),
                          !h.isPrimaryKey)
                        ) {
        ...
        function Xn(e, n, r) {
          ...
          return r.numFailures === 0
            ? n
            : n.type === `deleteRange` ||
                ((i = n.keys ? n.keys.length : `values` in n && n.values ? n.values.length : 1),
                r.numFailures === i)
              ? null
              : ((i = t({}, n)),
                a(i.keys) &&
        ...
        function Zn(e, t) {
          return (
            (n = e),
            ((r = t).lower === void 0 || (r.lowerOpen ? 0 < W(n, r.lower) : 0 <= W(n, r.lower))) &&
              ((n = e),
              (r = t).upper === void 0 || (r.upperOpen ? W(n, r.upper) < 0 : W(n, r.upper) <= 0))
          );
          var n, r;
        }
          ...
          return !n ||
            ...
            (r = n.reduce(function (e, n) {
              ...
              if (n.type === `add` || n.type === `put`)
                for (var o = new Z(), s = n.values.length - 1; 0 <= s; --s) {
                  var f,
                    p = n.values[s],
                    m = u(p);
                  !o.hasKey(m) &&
            ...
            : ((p = function (e, t) {
              ...
              t.limit &&
                ...
                (r.length > t.limit
                  ? (r.length = t.limit)
                  : e.length === t.limit && r.length < t.limit && (i.dirty = !0)),
              o ? Object.freeze(r) : r);
        }
        function $n(e, t) {
          return (
            ...
            return t(t({}, e), {
                      ...
                      (o = function (i) {
                        return function () {
                          if ((a.abort(), r === `readwrite`)) {
                            for (var o = new Set(), c = 0, l = t; c < l.length; c++) {
                              var u = l[c],
                                d = Mn[`idb://${n}/${u}`];
                              if (d) {
                                var f = e.table(u),
                                ...
                                if (s._explicit && i && s.mutatedParts)
                                  for (
                                    var m = 0, h = Object.values(d.queries.query);
                                    m < h.length;
                                    m++
                                  )
                                    for (var g = 0, _ = (b = h[m]).slice(); g < _.length; g++)
                                      jn((x = _[g]).obsSet, s.mutatedParts) &&
                                        (ae(b, x),
                                  ...
                                  for (
                                    var v = 0, y = Object.values(d.queries.query);
                                    v < y.length;
                                    v++
                                  )
                                    for (
                                      var b, x, S, C = 0, w = (b = y[v]).slice();
                                      C < w.length;
                                      C++
                                    )
                                      (x = w[C]).res != null &&
              ...
              table: function (r) {
                ...
                return t(t({}, i), {
                  mutate: function (e) {
                    ...
                    return !a.outbound &&
                      ...
                      ? ((s = i.mutate(e)),
                        ...
                        !(
                          50 <= e.values.length ||
                          Un(a, e).some(function (e) {
                            return e == null;
                          })
                        )
                          ? (o.optimisticOps.push(e),
                            e.mutatedParts && Fn(e.mutatedParts),
                            s.then(function (t) {
                              0 < t.numFailures &&
                                (ae(o.optimisticOps, e),
                                (t = Xn(0, e, t)) && o.optimisticOps.push(t),
                                e.mutatedParts) &&
                                Fn(e.mutatedParts);
                            }),
                            s.catch(function () {
                  ...
                  query: function (e) {
                    var t, a, o, s, c, l, u;
                    return qn(I, i) && Jn(`query`, e)
                      ? ((t = (o = I.trans)?.db._options.cache === `immutable`),
                        (a = (o = I).requery),
                        (o = o.signal),
                        (l = ((e, t, n, r) => {
                          var i = Mn[`idb://${e}/${t}`];
                              ...
                              var o = (s = r.direction) ?? `next`,
                                s = a.find(function (e) {
                                  return (
                                    ...
                                    $n(e.req.query.range, r.query.range)
                                  );
                                });
                              return s
                                ? [s, !0, i, a]
                                : [
                                    a.find(function (e) {
                                      return (
                                        (`limit` in e.req ? e.req.limit : 1 / 0) >= r.limit &&
                                        (e.req.direction ?? `next`) === o &&
                                        (!r.values || e.req.values) &&
                                        er(e.req.query.range, r.query.range)
                                      );
                                    }),
                                    !1,
                                    i,
                                ...
                                ((s ||= Mn[`idb://${n}/${r}`] =
                                  {
                                    ...
                                    optimisticOps: [],
                                    unsignaledParts: {},
                                  }).queries.query[e.query.index.name || ``] = c))),
                        tr(u, c, a, o),
                        u.promise.then(function (n) {
                          return (
                            (n = Qn(n.result, e, s?.optimisticOps, i, u, t)),
                            { result: t ? n : E(n) }
                          );
                        }))
                      : i.query(e);
        ...
        (($.prototype.version = function (e) {
          ...
          ($.prototype._whenReady = function (e) {
            var t = this;
            return this.idbdb && (this._state.openComplete || I.letThrough || this._vip)
              ? e()
              : new L(function (e, n) {
          ...
          ($.prototype._close = function () {
            ...
            e.isBeingOpened ||
              ((e.dbReadyPromise = new L(function (t) {
                e.dbReadyResolve = t;
              })),
          ...
          ($.prototype.close = function (e) {
            var e = (e === void 0 ? { disableAutoOpen: !0 } : e).disableAutoOpen,
              t = this._state;
            e
              ...
              function o() {
                ...
                ((n.onsuccess = R(function () {
                  var e = t._deps,
                    n = t.name,
                    r;
                  (xn((r = e.indexedDB)) || n === ut || bn(r, e.IDBKeyRange).delete(n).catch(j),
                    i());
                })),
                  (n.onerror = Y(a)),
          ...
          ($.prototype._transaction = function (e, t, n) {
            ...
            try {
              if (
                ((i = t.map(function (e) {
                  if (((e = e instanceof a.Table ? e.name : e), typeof e != `string`))
                    throw TypeError(
                ...
                if (e != `rw` && e != ft)
                  throw new A.InvalidArgument(`Invalid transaction mode: ` + e);
                r = ft;
              }
              if (o) {
                if (o.mode === dt && r === ft) {
              ...
              return L.resolve().then(function () {
                ...
                if (i) s.idbtrans = i.idbtrans;
                  ...
                  try {
                    ...
                    return i.name === pe.InvalidState && t.isOpen() && 0 < --t._state.PR1398_maxLoop
                      ? (console.warn(`Dexie: Need to reopen db`),
                        t.close({ disableAutoOpen: !1 }),
                        t.open().then(function () {
          ...
          ($.prototype.table = function (e) {
            ...
            throw new A.InvalidTable(`Table ${e} does not exist`);
          }));
        var Q = $;
        function $(e, n) {
          var r,
            ...
            s,
            c = this,
            l = ((this._middlewares = {}), (this.verno = 0), $.dependencies),
            l =
              ((this._options = n =
                t(
                  {
            ...
            d =
              ...
              (this._state = u),
              (this.name = e),
              (this.on = wt(this, `populate`, `blocked`, `versionchange`, `close`, {
                ready: [Ce, j],
              })),
                ...
                return function (t, n) {
                  $.vip(function () {
                    var r,
                      i = c._state;
                    i.openComplete
                      ? (i.dbOpenError || L.resolve().then(t), n && e(t))
                      : i.onReadyBeingFired
              ...
              (this.Collection =
                ...
                Tt(Nt.prototype, function (e, t) {
                  ...
                  this._ctx = {
                    ...
                    index: t.index,
                    isPrimKey:
                      !t.index || (e.schema.primKey.keyPath && t.index === e.schema.primKey.name),
                    range: n,
                    keysOnly: !1,
                    dir: `next`,
                    unique: ``,
                    ...
                    error: i,
                    or: t.or,
                    valueMapper: a === ge ? null : a,
                  };
                }))),
              (this.Table =
                ((i = this),
                Tt(Ct.prototype, function (e, t, n) {
                  ((this.db = i),
                    (this._tx = n),
                    (this.name = e),
                    (this.schema = t),
              ...
              (this.Transaction =
                ((a = this),
                Tt(Kt.prototype, function (e, t, n, r, i) {
                  var o = this;
                  (e !== `readonly` &&
                    t.forEach(function (e) {
                      ((e = (e = n[e])?.yProps),
                    ...
                    (this.idbtrans = null),
                    (this.on = wt(this, `complete`, `error`, `abort`)),
                    (this.parent = i || null),
                    (this.active = !0),
                    (this._reculock = 0),
                    (this._blockedFuncs = []),
                    ...
                    (this._spinCount = 0),
                    (this._completion = new L(function (e, t) {
              ...
              (this.WhereClause =
                ((s = this),
                Tt(Vt.prototype, function (e, t, n) {
                  if (
                    ((this.db = s),
                    (this._ctx = { table: e, index: t === `:id` ? null : t, or: n }),
                    (this._cmp = this._ascending = W),
                ...
                get: function (e, t, n) {
                  ...
                  return (
                    ...
                    (t === `table`
                      ...
                      : (r = Reflect.get(e, t, n)) instanceof Ct
                        ? rr(r, d)
                        : t === `tables`
                          ? r.map(function (e) {
                              return rr(e, d);
          ...
          ar =
            ((or.prototype.subscribe = function (e, t, n) {
              return this._subscribe(
                e && typeof e != `function` ? e : { next: e, error: t, complete: n },
              );
            }),
                  ...
                  !o &&
                    ...
                    (h = ((t) => {
                      ...
                      try {
                        i && tt();
                        var r = et(e, t);
                        return (r = i ? r.finally(B) : r);
                      } finally {
                        n && Ke();
                      }
                    })((m = { subscr: l, signal: a.signal, requery: d, querier: e, trans: null }))),
                    (u ||= (Gt.storagemutated.subscribe(p), !0)),
                    Promise.resolve(h).then(
                      ...
                      function (e) {
                        ((n = !1),
                          [`DatabaseClosedError`, `AbortError`].includes(e?.name) ||
                            o ||
                            st(function () {
                              o || (r.error && r.error(e));
                            }));
        ...
        (u(
          ...
          t(t({}, T), {
            ...
            ignoreTransaction: function (e) {
              return I.trans ? at(I.transless || F, e) : e();
            },
            vip: Sn,
            async: function (e) {
              return function () {
            ...
            waitFor: function (e, t) {
              return (
                (e = L.resolve(typeof e == `function` ? cr.ignoreTransaction(e) : e).timeout(
                  t || 6e4,
                )),
                I.trans ? I.trans.waitFor(e) : e
              );
            },
            Promise: L,
            debug: {
          ...
          (cr.maxKey = Xt(cr.dependencies.IDBKeyRange)),
          ...
          typeof addEventListener < `u` &&
            (addEventListener(`pagehide`, function (e) {
              if (!Q.disableBfCache && e.persisted) {
                (M && console.debug(`Dexie: handling persisted pagehide`), ur?.close());
                for (var t = 0, n = yn.toArray(); t < n.length; t++)
            ...
            addEventListener(`pageshow`, function (e) {
              !Q.disableBfCache &&
                e.persisted &&
                (M && console.debug(`Dexie: handling persisted pageshow`),
                fr(),
                lr({ all: new Z(-1 / 0, [[]]) }));
            })),
  ...
  A = Symbol.for(`Dexie`),
  he = globalThis[A] || (globalThis[A] = me.default);
if (me.default.semVer !== he.semVer)
  throw Error(
    `Two different versions of Dexie loaded in the same app: ${me.default.semVer} and ${he.semVer}`,
  );
var {
    liveQuery: j,
    mergeRanges: ge,
  ...
  Te = [`Boisson`, `Snack`, `Service`, `Autre`],
  Ee = class extends he {
    products;
    sales;
    sale_items;
  ...
  De = null;
function N() {
  if (typeof window > `u`) throw Error(`IndexedDB only available in the browser`);
  return ((De ||= new Ee()), De);
}
var P = () =>
...
async function Oe() {
  return (await N().products.toArray())
    .map((e) => ({ ...e, cost: e.cost ?? 0 }))
    .sort((e, t) => e.name.localeCompare(t.name));
}
async function ke(e) {
  let t = { ...e, id: P() };
  return (await N().products.put(t), t);
}
async function Ae(e) {
  await N().products.put(e);
}
async function je(e) {
  await N().products.delete(e);
}
async function Me(e) {
  let t = N(),
    n = e.lines.reduce((e, t) => e + t.price * t.quantity, 0),
    r = {
      id: P(),
      timestamp: Date.now(),
      total: n,
      cash_given: e.cash_given,
      change_due: e.cash_given - n,
      day_closed: !1,
    };
  return (
    await t.transaction(`rw`, t.sales, t.sale_items, t.products, async () => {
      await t.sales.put(r);
      for (let n of e.lines) {
        if (
          (await t.sale_items.put({
            id: P(),
            sale_id: r.id,
            product_id: n.product_id,
            name: n.name,
            quantity: n.quantity,
            price_at_sale: n.price,
            cost_at_sale: n.cost,
            category_at_sale: n.category,
          }),
          !n.product_id)
        )
          continue;
        let e = await t.products.get(n.product_id);
        e &&
          Number.isFinite(e.stock) &&
          (await t.products.put({ ...e, stock: Math.max(0, e.stock - n.quantity) }));
      }
    }),
    r
  );
...
async function Ne(e, t) {
  ...
  return (
    await (
      e !== void 0 && t !== void 0
        ? n.sales.where(`timestamp`).between(e, t, !0, !1)
        : n.sales.toCollection()
    ).toArray()
  )
    .filter((n) => (!e || n.timestamp >= e) && (!t || n.timestamp < t))
...
async function I(e) {
  return N().sale_items.where(`sale_id`).equals(e).toArray();
}
async function Fe(e) {
  return e.length === 0 ? [] : N().sale_items.where(`sale_id`).anyOf(e).toArray();
}
async function Ie(e) {
  let t = N();
  await t.transaction(`rw`, t.sales, t.sale_items, t.products, async () => {
    let n = await t.sales.get(e);
    if (!n) return;
    if (n.day_closed) throw Error(`Journée clôturée, annulation impossible.`);
    let r = await t.sale_items.where(`sale_id`).equals(e).toArray();
    for (let e of r) {
      if (e.product_id) {
        let n = await t.products.get(e.product_id);
        n &&
          Number.isFinite(n.stock) &&
          (await t.products.put({ ...n, stock: n.stock + e.quantity }));
      }
      await t.sale_items.delete(e.id);
    }
    await t.sales.delete(e);
  });
}
async function Le() {
  let e = N(),
    t = await F();
  return (
    await e.transaction(`rw`, e.sales, async () => {
      for (let n of t) n.day_closed || (await e.sales.put({ ...n, day_closed: !0 }));
    }),
    t.length
  );
}
async function L(e) {
  return (await N().settings.get(e))?.value;
}
async function Re(e, t) {
  await N().settings.put({ key: e, value: t });
}
function ze(e) {
...
function Be(e) {
  return new Date(e).toLocaleTimeString(`fr-FR`, { hour: `2-digit`, minute: `2-digit` });
}
function Ve(e, t = !1) {
  if (!Number.isFinite(e)) return `—`;
  let n = e * 100,
    r = `${Math.abs(n).toFixed(1).replace(`.`, `,`)} %`;
  return t ? `${n < 0 ? `−` : `+`}${r}` : `${n < 0 ? `-` : ``}${r}`;
}
function He(e) {
  return new Date(e).toLocaleDateString(`fr-FR`, { day: `2-digit`, month: `2-digit` });
}
function Ue(e) {
  let t = new Date(e).setHours(0, 0, 0, 0),
    n = new Date().setHours(0, 0, 0, 0);
  if (t === n) return `Aujourd'hui`;
  let r = new Date(n);
  return (
...
var We = D.forwardRef(({ className: e, ...t }, n) =>
  (0, E.jsx)(`div`, {
    ref: n,
    className: y(`rounded-xl border bg-card text-card-foreground shadow`, e),
    ...t,
  }),
);
We.displayName = `Card`;
var Ge = D.forwardRef(({ className: e, ...t }, n) =>
  (0, E.jsx)(`div`, { ref: n, className: y(`flex flex-col space-y-1.5 p-6`, e), ...t }),
);
Ge.displayName = `CardHeader`;
var Ke = D.forwardRef(({ className: e, ...t }, n) =>
  (0, E.jsx)(`div`, { ref: n, className: y(`font-semibold leading-none tracking-tight`, e), ...t }),
);
Ke.displayName = `CardTitle`;
var qe = D.forwardRef(({ className: e, ...t }, n) =>
  (0, E.jsx)(`div`, { ref: n, className: y(`text-sm text-muted-foreground`, e), ...t }),
);
qe.displayName = `CardDescription`;
var Je = D.forwardRef(({ className: e, ...t }, n) =>
  (0, E.jsx)(`div`, { ref: n, className: y(`p-6 pt-0`, e), ...t }),
);
Je.displayName = `CardContent`;
var R = D.forwardRef(({ className: e, ...t }, n) =>
  (0, E.jsx)(`div`, { ref: n, className: y(`flex items-center p-6 pt-0`, e), ...t }),
);
