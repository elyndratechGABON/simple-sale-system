import { n as e, r as t, t as n } from "./rolldown-runtime-QTnfLwEv.js";
import { M as r, P as i, n as a, t as o } from "./utils-7o9Ncrmj.js";
import { _ as s, b as c, n as l, t as u, w as d } from "./card-izC2g9JZ.js";
var f = n((e, t) => {
...
var B = P.forwardRef(function (e, t) {
    var n = e.children,
      r = e.className,
      i = Rt(e, It),
      o = a(`recharts-layer`, r);
    return P.createElement(`g`, Lt({ className: o }, z(i, !0), { ref: t }), n);
  }),
  Bt = n((e, t) => {
    function n(e, t, n) {
      var r = -1,
...
function mn(e, t) {
  var n = V(!0),
    ...
    a = null,
    o = cn(s);
  ((e = typeof e == `function` ? e : e === void 0 ? fn : V(e)),
    (t = typeof t == `function` ? t : t === void 0 ? pn : V(t)));
  function s(s) {
    var c,
      l = (s = ln(s)).length,
      u,
...
function hn(e, t, n) {
  ...
  ((e = typeof e == `function` ? e : e === void 0 ? fn : V(+e)),
    ...
    (n = typeof n == `function` ? n : n === void 0 ? pn : V(+n)));
  function l(l) {
    var u,
      d,
      f,
  ...
  function u() {
    return mn().defined(i).curve(o).context(a);
  }
  return (
    (l.x = function (t) {
...
var yn = {
  ...
  Tn = 0.8908130915292852,
  En = Yt(Zt / 10) / Yt((7 * Zt) / 10),
  Dn = Yt(Qt / 10) * En,
  On = -Jt(Qt / 10) * En,
  kn = {
    draw(e, t) {
  ...
  jn = {
    draw(e, t) {
      let n = -Xt(t / (An * 3));
      (e.moveTo(0, n * 2), e.lineTo(-An * n, -n), e.lineTo(An * n, -n), e.closePath());
    },
  },
  Mn = -0.5,
  Nn = Xt(3) / 2,
  ...
  In = {
    draw(e, t) {
      ...
      (e.moveTo(r, i),
        e.lineTo(a, o),
        e.lineTo(s, c),
        e.lineTo(Mn * r - Nn * i, Nn * r + Mn * i),
        e.lineTo(Mn * a - Nn * o, Nn * a + Mn * o),
        e.lineTo(Mn * s - Nn * c, Nn * s + Mn * c),
        e.lineTo(Mn * r + Nn * i, Mn * i - Nn * r),
        e.lineTo(Mn * a + Nn * o, Mn * o - Nn * a),
        e.lineTo(Mn * s + Nn * c, Mn * c - Nn * s),
        e.closePath());
    },
  };
function Ln(e, t) {
...
function Yn(e, t, n) {
  var r = e._x1 - e._x0,
    ...
    o = (n - e._y1) / (i || (r < 0 && -0)),
    s = (a * i + o * r) / (r + i);
  return (Jn(a) + Jn(o)) * Math.min(Math.abs(a), Math.abs(o), 0.5 * Math.abs(s)) || 0;
}
function Xn(e, t) {
  var n = e._x1 - e._x0;
  ...
  lineEnd: function () {
    switch (this._point) {
      case 2:
        ...
        break;
      case 3:
        Zn(this, this._t0, Xn(this, this._t0));
        break;
    }
    ((this._line || (this._line !== 0 && this._point === 1)) && this._context.closePath(),
      (this._line = 1 - this._line));
    ...
    if (((e = +e), (t = +t), !(e === this._x1 && t === this._y1))) {
      switch (this._point) {
        ...
        case 1:
          ...
          break;
        case 2:
          ((this._point = 3), Zn(this, Xn(this, (n = Yn(this, e, t))), n));
          break;
        default:
          Zn(this, this._t0, (n = Yn(this, e, t)));
          break;
      }
      ((this._x0 = this._x1),
        (this._x1 = e),
...
function $n(e) {
  this._context = new er(e);
}
($n.prototype = Object.create(Qn.prototype)).point = function (e, t) {
  ...
  lineEnd: function () {
    ...
    if (n)
      if (
        ...
        for (var r = ir(e), i = ir(t), a = 0, o = 1; o < n; ++a, ++o)
...
function mr() {
  var e = V([]),
    ...
    r = fr;
  function i(i) {
    var a = Array.from(e.apply(this, arguments), pr),
      o,
      s = a.length,
      c = -1,
      l;
    for (let e of i) for (o = 0, ++c; o < s; ++o) (a[o][c] = [0, +r(e, a[o].key, c, i)]).data = e;
    for (o = 0, l = ln(t(a)); o < s; ++o) a[l[o]].index = o;
    return (n(a, l), a);
  }
  return (
    (i.keys = function (t) {
    ...
    (i.order = function (e) {
      return arguments.length
        ? ((t = e == null ? dr : typeof e == `function` ? e : V(Array.from(e))), i)
        : t;
    }),
    (i.offset = function (e) {
      return arguments.length ? ((n = e ?? ur), i) : n;
    }),
    i
  );
}
...
var kr = {
  ...
  Ar = Math.PI / 180,
  jr = function (e) {
    return kr[`symbol${(0, vr.default)(e)}`] || yn;
  },
  Mr = function (e, t, n) {
    if (t === `area`) return e;
    switch (n) {
  ...
  Pr = function (e) {
    var t = e.type,
      ...
      o = e.sizeType,
      s = o === void 0 ? `area` : o,
      c = Cr(Cr({}, Dr(e, br)), {}, { type: n, size: i, sizeType: s }),
      l = function () {
        var e = jr(n);
        return Ln()
          .type(e)
    ...
    return d === +d && f === +f && i === +i
      ? P.createElement(
          `path`,
          xr({}, p, {
            className: a(`recharts-symbols`, u),
...
function Hr(e, t, n) {
  return (
    (t = Kr(t)),
    Ur(e, Gr() ? Reflect.construct(t, n || [], Kr(e).constructor) : t.apply(e, n))
  );
}
function Ur(e, t) {
...
var Qr = 32,
  $r = (function (e) {
    function t() {
      return (zr(this, t), Hr(this, t, arguments));
    }
    return (
      qr(t, e),
      Vr(t, [
          ...
          value: function (e) {
            ...
            if (e.type === `rect`)
              return P.createElement(`path`, {
                stroke: `none`,
                fill: a,
                d: `M0,${Qr / 8}h${Qr}v${(Qr * 3) / 4}h${-Qr}z`,
                className: `recharts-legend-icon`,
              });
          ...
          value: function () {
            ...
            return n.map(function (t, n) {
              var i = t.formatter || o,
                d = a(
                  Yr(
                    Yr({ "recharts-legend-item": !0 }, `legend-item-${n}`, !0),
                    `inactive`,
                    t.inactive,
                  ),
                );
              ...
              return P.createElement(
                `li`,
                Ir({ className: d, style: l, key: `legend-item-${n}` }, ct(e.props, t, n)),
...
var ei = n((e, t) => {
  ...
  Fi = n((e, t) => {
    t.exports = Pi()(Object.keys, Object);
  }),
  Ii = n((e, t) => {
    var n = Ni(),
      r = Fi(),
...
function va(e, t, n) {
  return t === !0 ? (0, _a.default)(e, n) : (0, R.default)(t) ? (0, _a.default)(e, t) : e;
}
function ya(e) {
  "@babel/helpers - typeof";
  return (
...
function Ea(e, t, n) {
  return (
    (t = Aa(t)),
    Da(e, ka() ? Reflect.construct(t, n || [], Aa(e).constructor) : t.apply(e, n))
  );
}
function Da(e, t) {
  ...
  Va = (function (e) {
    function t() {
      ...
      return (
        ...
        Na(e, `lastBoundingBox`, { width: -1, height: -1 }),
        e
      );
    }
    return (
          ...
          },
          {
            ...
            value: function () {
              var e = this.props.onBBoxUpdate,
                t = this.getBBox();
              t
                ? (Math.abs(t.width - this.lastBoundingBox.width) > Ba ||
                    Math.abs(t.height - this.lastBoundingBox.height) > Ba) &&
          ...
          },
          {
            ...
            value: function () {
              ...
              return P.createElement(
                ...
                za(n, Sa(Sa({}, this.props), {}, { payload: va(s, o, Ra) })),
              );
            },
          },
        ],
        [
          {
            key: `getWithHeight`,
            value: function (e, t) {
              var n = Sa(Sa({}, this.defaultProps), e.props).layout;
...
var Do = function (e) {
  var t = e.separator,
    ...
    y = function () {
      if (u && u.length) {
        var e = { padding: 0, margin: 0 },
          t = (f ? (0, fo.default)(u, f) : u).map(function (e, t) {
    ...
    S = !(0, F.default)(h),
    C = S ? h : ``,
    w = a(`recharts-default-tooltip`, p),
    T = a(`recharts-tooltip-label`, m);
  S && g && u != null && (C = g(h, u));
  var E = v ? { role: `status`, "aria-live": `assertive` } : {};
  return P.createElement(
    `div`,
    mo({ className: w, style: b }, E),
...
var Mo = `recharts-tooltip-wrapper`,
  ...
  return (
    o.height > 0 && o.width > 0 && n
      ? ((u = Fo({
        ...
        (l = Io({ translateX: u, translateY: d, useTranslate3d: s })))
      : (l = No),
    { cssProperties: l, cssClasses: Po({ translateX: u, translateY: d, coordinate: n }) }
  );
}
function Ro(e) {
  "@babel/helpers - typeof";
...
function Wo(e, t, n) {
  return (
    (t = Jo(t)),
    Go(e, qo() ? Reflect.construct(t, n || [], Jo(e).constructor) : t.apply(e, n))
  );
}
function Go(e, t) {
...
var es = 1,
  ts = (function (e) {
    function t() {
      ...
      var n = [...arguments];
      return (
        (e = Wo(this, t, [].concat(n))),
        Zo(e, `state`, {
          dismissed: !1,
          dismissedAtCoordinate: { x: 0, y: 0 },
          lastBoundingBox: { width: -1, height: -1 },
        }),
        Zo(e, `handleKeyDown`, function (t) {
          t.key === `Escape` &&
            e.setState({
              dismissed: !0,
      ...
      Uo(t, [
        {
          ...
          value: function () {
            if (this.wrapperNode && this.wrapperNode.getBoundingClientRect) {
              var e = this.wrapperNode.getBoundingClientRect();
              (Math.abs(e.width - this.state.lastBoundingBox.width) > es ||
                Math.abs(e.height - this.state.lastBoundingBox.height) > es) &&
        ...
        },
        {
          ...
          value: function () {
            var e = this,
              ...
              v = g.cssProperties,
              y = Bo(
                Bo({ transition: l && n ? `transform ${i}ms ${a}` : void 0 }, v),
                {},
                {
                  pointerEvents: `none`,
...
function ss(e, t) {
  for (var n = 0; n < t.length; n++) {
    ...
    ((r.enumerable = r.enumerable || !1),
      (r.configurable = !0),
      `value` in r && (r.writable = !0),
      Object.defineProperty(e, _s(r.key), r));
  }
}
function cs(e, t, n) {
  return (
...
function ls(e, t, n) {
  return (
    (t = ps(t)),
    us(e, fs() ? Reflect.construct(t, n || [], ps(e).constructor) : t.apply(e, n))
  );
}
function us(e, t) {
    ...
    cs(t, [
      {
        ...
        value: function () {
          ...
          return P.createElement(
            ...
            bs(o, as(as({}, this.props), {}, { payload: v })),
          );
        },
      },
    ])
...
var Bs = (0, P.forwardRef)(function (e, t) {
    var n = e.aspect,
    ...
    var w = Ps((0, P.useState)({ containerWidth: i.width, containerHeight: i.height }), 2),
      T = w[0],
      E = w[1],
    ...
    (0, P.useEffect)(
      function () {
        ...
        g > 0 && (e = (0, Ds.default)(e, g, { trailing: !0, leading: !1 }));
    ...
    return P.createElement(
      ...
      {
        id: _ ? `${_}` : void 0,
        className: a(`recharts-responsive-container`, v),
        style: As(As({}, x), {}, { width: s, height: l, minWidth: d, minHeight: f, maxHeight: p }),
        ref: S,
      },
      O,
    );
...
var Js = { widthCache: {}, cacheCount: 0 },
  Ys = 2e3,
  Xs = {
    position: `absolute`,
    top: `-20000px`,
...
var $s = function (e) {
    ...
    if (Js.widthCache[r]) return Js.widthCache[r];
    try {
      var i = document.getElementById(Zs);
      i ||
        ((i = document.createElement(`span`)),
        i.setAttribute(`id`, Zs),
      ...
      return (
        (Js.widthCache[r] = s),
        ++Js.cacheCount > Ys && ((Js.cacheCount = 0), (Js.widthCache = {})),
        s
      );
    } catch {
...
function lc(e, t) {
  for (var n = 0; n < t.length; n++) {
    ...
    ((r.enumerable = r.enumerable || !1),
      (r.configurable = !0),
      `value` in r && (r.writable = !0),
      Object.defineProperty(e, dc(r.key), r));
  }
}
function uc(e, t, n) {
  return (
...
var pc = /(-?\d+(?:\.\d+)?[a-zA-Z%]*)([*/])(-?\d+(?:\.\d+)?[a-zA-Z%]*)/,
  mc = /(-?\d+(?:\.\d+)?[a-zA-Z%]*)([+-])(-?\d+(?:\.\d+)?[a-zA-Z%]*)/,
  hc = /^px|cm|vh|vw|em|rem|%|mm|in|pt|pc|ex|ch|vmin|vmax|Q$/,
  gc = /(-?\d+(?:\.\d+)?)([a-zA-Z%]+)?/,
  _c = {
    cm: 96 / 2.54,
    mm: 96 / 25.4,
...
var xc = (function () {
  function e(t, n) {
    (cc(this, e),
      ...
      n !== `` && !hc.test(n) && ((this.num = NaN), (this.unit = ``)),
      vc.includes(n) && ((this.num = bc(t, n)), (this.unit = `px`)));
  }
  return uc(
    e,
    [
...
function Sc(e) {
  if (e.includes(yc)) return yc;
  for (var t = e; t.includes(`*`) || t.includes(`/`);) {
    var n = nc(pc.exec(t) ?? [], 4),
      r = n[1],
      i = n[2],
      a = n[3],
      o = xc.parse(r ?? ``),
    ...
    if (c.isNaN()) return yc;
    t = t.replace(pc, c.toString());
  }
  for (; t.includes(`+`) || /.-\d+(?:\.\d+)?/.test(t);) {
    var l = nc(mc.exec(t) ?? [], 4),
      u = l[1],
      d = l[2],
      f = l[3],
      p = xc.parse(u ?? ``),
    ...
    if (h.isNaN()) return yc;
    t = t.replace(mc, h.toString());
  }
  return t;
}
var Cc = /\(([^()]*)\)/;
...
var Oc = [
  ...
  kc = [`dx`, `dy`, `angle`, `className`, `breakAll`];
function Ac() {
  return (
    (Ac = Object.assign
      ? Object.assign.bind()
...
var zc = /[ \f\n\r\t\v\u2028\u2029]+/,
  Bc = function (e) {
    ...
    try {
      var i = [];
      return (
        (0, F.default)(t) || (i = n ? t.toString().split(``) : t.toString().split(zc)),
        {
          wordsWithComputedWidth: i.map(function (e) {
            return { word: e, width: $s(e, r).width };
          }),
          spaceWidth: n ? 0 : $s(`\xA0`, r).width,
        }
      );
    } catch {
      return null;
  ...
  Vc = function (e, t, n, r, i) {
    ...
    for (
      var m = `…`,
        h = function (e) {
          var t = Bc({ breakAll: c, style: s, children: u.slice(0, e) + m }).wordsWithComputedWidth,
            n = d(t);
  ...
  Hc = function (e) {
    return [{ words: (0, F.default)(e) ? [] : e.toString().split(zc) }];
  },
  Uc = function (e) {
    var t = e.width,
      n = e.scaleToFit,
    ...
    if ((t || n) && !ns.isSsr) {
      var s,
        c,
        l = Bc({ breakAll: a, children: r, style: i });
      if (l) {
        var u = l.wordsWithComputedWidth,
          d = l.spaceWidth;
        ((s = u), (c = d));
      } else return Hc(r);
      return Vc({ breakAll: a, children: r, maxLines: o, style: i }, s, c, t, n);
    }
    return Hc(r);
  },
  Wc = `#808080`,
  Gc = function (e) {
    ...
    switch (h) {
      case `start`:
        ...
        break;
      case `middle`:
        O = Dc(`calc(${(y.length - 1) / 2} * -${s} + (${l} / 2))`);
        break;
      default:
        O = Dc(`calc(${y.length - 1} * -${s})`);
        break;
    }
    var k = [];
    if (d) {
    ...
    return (
      ...
      P.createElement(
        ...
        Ac({}, z(T, !0), {
          x: E,
          y: D,
          className: a(`recharts-text`, C),
          textAnchor: p,
          fill: _.includes(`url`) ? Wc : _,
        }),
        y.map(function (e, t) {
          var n = e.words.join(w ? `` : ` `);
          return P.createElement(`tspan`, { x: E, dy: t === 0 ? O : s, key: `${n}-${t}` }, n);
        }),
      )
    );
  };
...
function Jc(e) {
  let t, n, r;
  e.length === 2
    ? ((t = e === Kc || e === qc ? e : Yc), (n = e), (r = e))
    : ((t = Kc), (n = (t, n) => Kc(e(t), n)), (r = (t, n) => e(t) - n));
...
var Qc = Jc(Kc),
  $c = Qc.right;
(Qc.left, Jc(Xc).center);
var el = class extends Map {
  constructor(e, t = il) {
    if (
      (super(),
  ...
  get(e) {
    return super.get(tl(this, e));
  }
  has(e) {
    return super.has(tl(this, e));
  }
  set(e, t) {
    return super.set(nl(this, e), t);
  }
  delete(e) {
    return super.delete(rl(this, e));
  }
};
  ...
  return (
    i < 0
      ...
      : ((l = 10 ** i * o),
        ...
        s * l < e && ++s,
        c * l > t && --c),
    c < s && 0.5 <= n && n < 2 ? ul(e, t, n * 2) : [s, c, l]
  );
}
function dl(e, t, n) {
...
function fl(e, t, n) {
  return ((t = +t), (e = +e), (n = +n), ul(e, t, n)[2]);
}
function pl(e, t, n) {
  ((t = +t), (e = +e), (n = +n));
  let r = t < e,
    i = r ? fl(t, e, n) : fl(e, t, n);
...
function gl(e, t, n = 0, r = 1 / 0, i) {
  ...
  for (i = i === void 0 ? ol : al(i); r > n;) {
    ...
    let a = e[t],
      o = n,
      s = r;
    for (_l(e, n, t), i(e[r], a) > 0 && _l(e, n, r); o < s;) {
      for (_l(e, o, s), ++o, --s; i(e[o], a) < 0;) ++o;
      for (; i(e[s], a) > 0;) --s;
    }
    (i(e[n], a) === 0 ? _l(e, n, s) : (++s, _l(e, s, r)),
      s <= t && (n = s + 1),
      t <= s && (r = s - 1));
  }
  return e;
...
function vl(e, t, n) {
  if (((e = Float64Array.from(Zc(e, n))), !(!(r = e.length) || isNaN((t = +t))))) {
    if (t <= 0 || r < 2) return hl(e);
    if (t >= 1) return ml(e);
    var r,
      i = (r - 1) * t,
      a = Math.floor(i),
      o = ml(gl(e, a).subarray(0, a + 1));
    return o + (hl(e.subarray(a + 1)) - o) * (i - a);
  }
}
function yl(e, t, n = Xc) {
...
function Tl() {
  ...
  return (
    ...
    (e.copy = function () {
      return Tl(t(), [r, i]).round(s).paddingInner(c).paddingOuter(l).align(u);
    }),
...
function Dl() {
  return El(Tl.apply(null, arguments).paddingInner(1));
}
function Ol(e, t, n) {
...
var jl = 0.7,
  ...
  Fl = `\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*`,
  Il = /^#([0-9a-f]{3,8})$/,
  Ll = RegExp(`^rgb\\(${Nl},${Nl},${Nl}\\)$`),
  Rl = RegExp(`^rgb\\(${Fl},${Fl},${Fl}\\)$`),
  zl = RegExp(`^rgba\\(${Nl},${Nl},${Nl},${Pl}\\)$`),
  Bl = RegExp(`^rgba\\(${Fl},${Fl},${Fl},${Pl}\\)$`),
  Vl = RegExp(`^hsl\\(${Pl},${Fl},${Fl}\\)$`),
  Hl = RegExp(`^hsla\\(${Pl},${Fl},${Fl},${Pl}\\)$`),
  Ul = {
    aliceblue: 15792383,
  ...
  return (
    ...
    (t = Il.exec(e))
      ? ((n = t[1].length),
        ...
        n === 6
          ...
          : n === 3
            ...
            : n === 8
              ? Xl((t >> 24) & 255, (t >> 16) & 255, (t >> 8) & 255, (t & 255) / 255)
              : n === 4
                ? Xl(
                    ((t >> 12) & 15) | ((t >> 8) & 240),
                    ((t >> 8) & 15) | ((t >> 4) & 240),
      ...
      : (t = Ll.exec(e))
        ? new $l(t[1], t[2], t[3], 1)
        : (t = Rl.exec(e))
          ? new $l((t[1] * 255) / 100, (t[2] * 255) / 100, (t[3] * 255) / 100, 1)
          : (t = zl.exec(e))
            ? Xl(t[1], t[2], t[3], t[4])
            : (t = Bl.exec(e))
              ? Xl((t[1] * 255) / 100, (t[2] * 255) / 100, (t[3] * 255) / 100, t[4])
              : (t = Vl.exec(e))
                ? ou(t[1], t[2] / 100, t[3] / 100, 1)
                : (t = Hl.exec(e))
                  ? ou(t[1], t[2] / 100, t[3] / 100, t[4])
                  : Ul.hasOwnProperty(e)
                    ? Yl(Ul[e])
                    : e === `transparent`
                      ? new $l(NaN, NaN, NaN, 0)
...
function Zl(e) {
  return (
    e instanceof Al || (e = Jl(e)),
    e ? ((e = e.rgb()), new $l(e.r, e.g, e.b, e.opacity)) : new $l()
  );
}
function Ql(e, t, n, r) {
  return arguments.length === 1 ? Zl(e) : new $l(e, t, n, r ?? 1);
}
function $l(e, t, n, r) {
...
Ol(
  ...
  kl(Al, {
    ...
    clamp() {
      return new $l(iu(this.r), iu(this.g), iu(this.b), ru(this.opacity));
    },
    displayable() {
      return (
        -0.5 <= this.r &&
...
function tu() {
  return `#${au(this.r)}${au(this.g)}${au(this.b)}${au((isNaN(this.opacity) ? 1 : this.opacity) * 255)}`;
}
function nu() {
  let e = ru(this.opacity);
  return `${e === 1 ? `rgb(` : `rgba(`}${iu(this.r)}, ${iu(this.g)}, ${iu(this.b)}${e === 1 ? `)` : `, ${e})`}`;
}
function ru(e) {
...
function au(e) {
  return ((e = iu(e)), (e < 16 ? `0` : ``) + e.toString(16));
}
function ou(e, t, n, r) {
  return (
...
function su(e) {
  if (e instanceof lu) return new lu(e.h, e.s, e.l, e.opacity);
  if ((e instanceof Al || (e = Jl(e)), !e)) return new lu();
  ...
  return (
    s
      ? ((o = t === a ? (n - r) / s + (n < r) * 6 : n === a ? (r - t) / s + 2 : (t - n) / s + 4),
        ...
        (o *= 60))
      : (s = c > 0 && c < 1 ? 0 : o),
    new lu(o, s, c, e.opacity)
  );
}
function cu(e, t, n, r) {
  return arguments.length === 1 ? su(e) : new lu(e, t, n, r ?? 1);
}
function lu(e, t, n, r) {
...
Ol(
  ...
  kl(Al, {
    brighter(e) {
      return ((e = e == null ? Ml : Ml ** +e), new lu(this.h, this.s, this.l * e, this.opacity));
    },
    darker(e) {
      return ((e = e == null ? jl : jl ** +e), new lu(this.h, this.s, this.l * e, this.opacity));
    },
    rgb() {
      var e = (this.h % 360) + (this.h < 0) * 360,
        ...
        i = 2 * n - r;
      return new $l(
        fu(e >= 240 ? e - 240 : e + 120, i, r),
        fu(e, i, r),
        fu(e < 120 ? e + 240 : e - 120, i, r),
        this.opacity,
      );
    },
    clamp() {
      return new lu(uu(this.h), du(this.s), du(this.l), ru(this.opacity));
    },
    displayable() {
      return (
    ...
    formatHsl() {
      let e = ru(this.opacity);
      return `${e === 1 ? `hsl(` : `hsla(`}${uu(this.h)}, ${du(this.s) * 100}%, ${du(this.l) * 100}%${e === 1 ? `)` : `, ${e})`}`;
    },
  }),
);
function uu(e) {
...
function gu(e) {
  return (e = +e) == 1
    ? _u
    : function (t, n) {
        return n - t ? hu(t, n, e) : pu(isNaN(t) ? n : t);
      };
}
function _u(e, t) {
  var n = t - e;
  return n ? mu(e, n) : pu(isNaN(e) ? t : e);
}
var vu = (function e(t) {
  var n = gu(t);
  function r(e, t) {
    var r = n((e = Ql(e)).r, (t = Ql(t)).r),
      i = n(e.g, t.g),
      a = n(e.b, t.b),
      o = _u(e.opacity, t.opacity);
    return function (t) {
...
function ku(e, t) {
  var n = (Tu.lastIndex = Eu.lastIndex = 0),
    r,
    i,
    a,
    o = -1,
    s = [],
    c = [];
  for (e += ``, t += ``; (r = Tu.exec(e)) && (i = Eu.exec(t));)
    ((a = i.index) > n && ((a = t.slice(n, a)), s[o] ? (s[o] += a) : (s[++o] = a)),
      (r = r[0]) === (i = i[0])
        ? s[o]
          ? (s[o] += i)
          : (s[++o] = i)
        : ((s[++o] = null), c.push({ i: o, x: Cu(r, i) })),
      (n = Eu.lastIndex));
  return (
...
function zu(e, t, n) {
  var r = e[0],
    ...
    o = t[1];
  return (
    i < r ? ((r = Lu(i, r)), (a = n(o, a))) : ((r = Lu(r, i)), (a = n(a, o))),
    function (e) {
      return a(r(e));
    }
  );
...
function Bu(e, t, n) {
  ...
  for (e[r] < e[0] && ((e = e.slice().reverse()), (t = t.slice().reverse())); ++o < r;)
    ((i[o] = Lu(e[o], e[o + 1])), (a[o] = n(t[o], t[o + 1])));
  return function (t) {
    var n = $c(e, t, 1, r) - 1;
    return a[n](i[n](t));
  };
...
function Hu() {
  ...
  function u() {
    ...
    return (o !== Iu && (o = Ru(e[0], e[n - 1])), (s = n > 2 ? Bu : zu), (c = l = null), d);
  }
  function d(i) {
  ...
  return (
    (d.invert = function (n) {
      return o(i((l ||= s(t, e.map(r), Cu))(n)));
    }),
    (d.domain = function (t) {
      return arguments.length ? ((e = Array.from(t, Pu)), u()) : e.slice();
    }),
    (d.range = function (e) {
      return arguments.length ? ((t = Array.from(e)), u()) : t.slice();
    }),
    (d.rangeRound = function (e) {
      return ((t = Array.from(e)), (n = ju), u());
    }),
    (d.clamp = function (e) {
      return arguments.length ? ((o = e ? !0 : Iu), u()) : o !== Iu;
    }),
...
function Ku(e) {
  return ((e = Gu(Math.abs(e))), e ? e[1] : NaN);
}
function qu(e, t) {
  return function (n, r) {
    for (
...
var Yu = /^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;
function Xu(e) {
  if (!(t = Yu.exec(e))) throw Error(`invalid format: ` + e);
  var t;
  return new Zu({
    fill: t[1],
    align: t[2],
...
function ed(e, t) {
  ...
  var r = n[0],
    i = n[1],
    a = i - ($u = Math.max(-8, Math.min(8, Math.floor(i / 3))) * 3) + 1,
    o = r.length;
  return a === o
    ? r
    : a > o
      ...
      : a > 0
        ...
        : `0.` + Array(1 - a).join(`0`) + Gu(e, Math.max(0, t + a - 1))[0];
}
function td(e, t) {
  var n = Gu(e, t);
  if (!n) return e + ``;
...
var id = Array.prototype.map,
  ad = [`y`, `z`, `a`, `f`, `p`, `n`, `µ`, `m`, ``, `k`, `M`, `G`, `T`, `P`, `E`, `Z`, `Y`];
function od(e) {
  var t =
      e.grouping === void 0 || e.thousands === void 0
        ? rd
        : qu(id.call(e.grouping, Number), e.thousands + ``),
    n = e.currency === void 0 ? `` : e.currency[0] + ``,
    r = e.currency === void 0 ? `` : e.currency[1] + ``,
    i = e.decimal === void 0 ? `.` : e.decimal + ``,
    a = e.numerals === void 0 ? rd : Ju(id.call(e.numerals, String)),
  ...
  function l(e, l) {
    ...
    var u = e.fill,
      ...
      v = e.trim,
      y = e.type;
    (y === `n` ? ((g = !0), (y = `g`)) : nd[y] || (_ === void 0 && (_ = 12), (v = !0), (y = `g`)),
      (m || (u === `0` && d === `=`)) && ((m = !0), (u = `0`), (d = `=`)));
    var b =
  ...
  function u(e, t) {
    var n = Math.max(-8, Math.min(8, Math.floor(Ku(t) / 3))) * 3,
      r = 10 ** -n,
      i = l(((e = Xu(e)), (e.type = `f`), e), { suffix: ad[8 + n / 3] });
    return function (e) {
      return i(r * e);
    };
  }
...
function ud(e) {
  return ((sd = od(e)), (cd = sd.format), (ld = sd.formatPrefix), sd);
}
function dd(e) {
  return Math.max(0, -Ku(Math.abs(e)));
}
function fd(e, t) {
  return Math.max(0, Math.max(-8, Math.min(8, Math.floor(Ku(t) / 3))) * 3 - Ku(Math.abs(e)));
}
function pd(e, t) {
  return ((e = Math.abs(e)), (t = Math.abs(t) - e), Math.max(0, Ku(t) - Ku(e)) + 1);
}
function md(e, t, n, r) {
  var i = pl(e, t, n),
    a;
  switch (((r = Xu(r ?? `,f`)), r.type)) {
    case `s`:
      var o = Math.max(Math.abs(e), Math.abs(t));
      return (r.precision == null && !isNaN((a = fd(i, o))) && (r.precision = a), ld(r, o));
    case ``:
    case `e`:
    case `g`:
    case `p`:
    case `r`:
      r.precision == null &&
        !isNaN((a = pd(i, Math.max(Math.abs(e), Math.abs(t))))) &&
        (r.precision = a - (r.type === `e`));
      break;
    case `f`:
    case `%`:
      r.precision == null && !isNaN((a = dd(i))) && (r.precision = a - (r.type === `%`) * 2);
      break;
  }
  return cd(r);
}
function hd(e) {
  ...
  return (
    (e.ticks = function (e) {
      var n = t();
      return dl(n[0], n[n.length - 1], e ?? 10);
    }),
    (e.tickFormat = function (e, n) {
      var r = t();
      return md(r[0], r[r.length - 1], e ?? 10, n);
    }),
    (e.nice = function (n) {
      n ??= 10;
      var r = t(),
      ...
      for (s < o && ((l = o), (o = s), (s = l), (l = i), (i = a), (a = l)); u-- > 0;) {
        if (((l = fl(o, s, n)), l === c)) return ((r[i] = o), (r[a] = s), t(r));
...
function _d(e) {
  ...
  return (
    ...
    (n.domain = n.range =
      function (t) {
        return arguments.length ? ((e = Array.from(t, Pu)), n) : e.slice();
      }),
    ...
    (e = arguments.length ? Array.from(e, Pu) : [0, 1]),
    hd(n)
  );
}
function vd(e, t) {
...
function wd(e) {
  return e === 10 ? Cd : e === Math.E ? Math.exp : (t) => e ** +t;
}
function Td(e) {
  return e === Math.E
    ? Math.log
...
function Dd(e) {
  ...
  function o() {
    return (
      (i = Td(r)),
      (a = wd(r)),
      n()[0] < 0 ? ((i = Ed(i)), (a = Ed(a)), e(xd, Sd)) : e(yd, bd),
      t
    );
  }
  return (
    ...
    (t.ticks = (e) => {
      ...
      if (!(r % 1) && u - l < p) {
        ...
        m.length * 2 < p && (m = dl(o, s, p));
      } else m = dl(l, u, Math.min(u - l, p)).map(a);
    ...
    (t.tickFormat = (e, n) => {
      if (
        ...
        (n ??= r === 10 ? `s` : `,`),
        typeof n != `function` &&
          (!(r % 1) && (n = Xu(n)).precision == null && (n.trim = !0), (n = cd(n))),
        e === 1 / 0)
      )
        return n;
    ...
    (t.nice = () =>
      n(vd(n(), { floor: (e) => a(Math.floor(i(e))), ceil: (e) => a(Math.ceil(i(e))) }))),
    t
  );
}
function Od() {
  let e = Dd(Hu()).domain([1, 10]);
  return ((e.copy = () => Vu(e, Od()).base(e.base())), xl.apply(e, arguments), e);
}
function kd(e) {
  return function (t) {
...
function jd(e) {
  ...
  return (
    (n.constant = function (n) {
      return arguments.length ? e(kd((t = +n)), Ad(t)) : t;
    }),
    hd(n)
  );
}
function Md() {
  ...
  return (
    (e.copy = function () {
      return Vu(e, Md()).constant(e.constant());
    }),
    xl.apply(e, arguments)
  );
}
...
function Id(e) {
  var t = e(Iu, Iu),
    n = 1;
  function r() {
    return n === 1 ? e(Iu, Iu) : n === 0.5 ? e(Pd, Fd) : e(Nd(n), Nd(1 / n));
  }
  return (
...
function Ld() {
  ...
  return (
    (e.copy = function () {
      return Vu(e, Ld()).exponent(e.exponent());
    }),
    xl.apply(e, arguments),
    e
  );
...
function Vd() {
  ...
  return (
    (i.invert = function (t) {
      return e.invert(zd(t));
    }),
    (i.domain = function (t) {
      return arguments.length ? (e.domain(t), i) : e.domain();
    }),
    (i.range = function (n) {
      return arguments.length ? (e.range((t = Array.from(n, Pu)).map(zd)), i) : t.slice();
    }),
    ...
    (i.copy = function () {
      return Vd(e.domain(), t).round(n).clamp(e.clamp()).unknown(r);
    }),
    xl.apply(i, arguments),
    hd(i)
  );
...
function Hd() {
  ...
  function i() {
    ...
    for (n = Array(i - 1); ++r < i;) n[r - 1] = yl(e, r / i);
    return a;
  }
  function a(e) {
...
function Ud() {
  ...
  return (
    ...
    (o.copy = function () {
      return Ud().domain([e, t]).range(i).unknown(a);
    }),
    xl.apply(hd(o), arguments)
  );
}
function Wd() {
  var e = [0.5],
  ...
  return (
    ...
    (i.copy = function () {
      return Wd().domain(e).range(t).unknown(n);
    }),
    xl.apply(i, arguments)
  );
}
...
function H(e, t, n, r) {
  ...
  return (
    ...
    n &&
      ((i.count = (t, r) => (Gd.setTime(+t), Kd.setTime(+r), e(Gd), e(Kd), Math.floor(n(Gd, Kd)))),
      (i.every = (e) => (
        (e = Math.floor(e)),
        !isFinite(e) || !(e > 0)
          ? null
...
var nf = H(
  (e) => {
    e.setTime(e - e.getMilliseconds() - e.getSeconds() * Jd);
  },
  (e, t) => {
    e.setTime(+e + t * Yd);
  },
...
var af = H(
  (e) => {
    e.setTime(e - e.getMilliseconds() - e.getSeconds() * Jd - e.getMinutes() * Yd);
  },
  (e, t) => {
    e.setTime(+e + t * Xd);
  },
...
var sf = H(
  ...
  (e, t) => (t - e - (t.getTimezoneOffset() - e.getTimezoneOffset()) * Yd) / Zd,
  (e) => e.getDate() - 1,
);
sf.range;
var cf = H(
...
function uf(e) {
  return H(
    ...
    (e, t) => (t - e - (t.getTimezoneOffset() - e.getTimezoneOffset()) * Yd) / Qd,
  );
}
var df = uf(0),
  ff = uf(1),
...
var yf = vf(0),
  ...
  wf = vf(5),
  Tf = vf(6);
(yf.range, bf.range, xf.range, Sf.range, Cf.range, wf.range, Tf.range);
var Ef = H(
  (e) => {
...
function Af(e, t, n, r, i, a) {
  ...
  function c(t, n, r) {
    let i = Math.abs(n - t) / r,
      a = Jc(([, , e]) => e).right(o, i);
    if (a === o.length) return e.every(pl(t / ef, n / ef, r));
    if (a === 0) return qd.every(Math.max(pl(t, n, r), 1));
    let [s, c] = o[i / o[a - 1][2] < o[a][2] / i ? a - 1 : a];
    return s.every(c);
  }
  return [s, c];
}
var [jf, Mf] = Af(kf, Df, yf, lf, of, rf),
  [Nf, Pf] = Af(Of, Ef, df, sf, af, nf);
function Ff(e) {
  if (0 <= e.y && e.y < 100) {
  ...
  function S(e, t) {
    return function (n) {
      ...
      for (n instanceof Date || (n = new Date(+n)); ++i < o;)
        e.charCodeAt(i) === 37 &&
          (r.push(e.slice(a, i)),
          (c = zf[(s = e.charAt(++i))]) == null ? (c = s === `e` ? ` ` : `0`) : (s = e.charAt(++i)),
          (l = t[s]) && (s = l(n, c)),
          r.push(s),
          (a = i + 1));
      ...
      if (
        ...
        (`w` in r || (r.w = 1),
          `Z` in r
            ? ((a = If(Lf(r.y, 0, 1))),
              (o = a.getUTCDay()),
              (a = o > 4 || o === 0 ? bf.ceil(a) : bf(a)),
              (a = cf.offset(a, (r.V - 1) * 7)),
              (r.y = a.getUTCFullYear()),
              (r.m = a.getUTCMonth()),
              (r.d = a.getUTCDate() + ((r.w + 6) % 7)))
            : ((a = Ff(Lf(r.y, 0, 1))),
              (o = a.getDay()),
              (a = o > 4 || o === 0 ? ff.ceil(a) : ff(a)),
        ...
        (`W` in r || `U` in r) &&
          ...
          (o = `Z` in r ? If(Lf(r.y, 0, 1)).getUTCDay() : Ff(Lf(r.y, 0, 1)).getDay()),
          (r.m = 0),
          (r.d =
            `W` in r ? ((r.w + 6) % 7) + r.W * 7 - ((o + 5) % 7) : r.w + r.U * 7 - ((o + 6) % 7)));
      return `Z` in r ? ((r.H += (r.Z / 100) | 0), (r.M += r.Z % 100), If(r)) : Ff(r);
    };
  }
  function w(e, t, n, r) {
    for (var i = 0, a = t.length, o = n.length, s, c; i < a;) {
      ...
      if (((s = t.charCodeAt(i++)), s === 37)) {
        if (((s = t.charAt(i++)), (c = x[s in zf ? t.charAt(i++) : s]), !c || (r = c(e, n, r)) < 0))
          return -1;
...
function mp(e, t) {
  return W(1 + sf.count(Of(e), e), t, 3);
}
function hp(e, t) {
...
function xp(e, t) {
  return W(df.count(Of(e) - 1, e), t, 2);
}
function Sp(e) {
  var t = e.getDay();
...
function Cp(e, t) {
  return ((e = Sp(e)), W(hf.count(Of(e), e) + (Of(e).getDay() === 4), t, 2));
}
function wp(e) {
  return e.getDay();
}
function Tp(e, t) {
  return W(ff.count(Of(e) - 1, e), t, 2);
}
function Ep(e, t) {
  return W(e.getFullYear() % 100, t, 2);
}
function Dp(e, t) {
  return ((e = Sp(e)), W(e.getFullYear() % 100, t, 2));
}
function Op(e, t) {
...
function kp(e, t) {
  var n = e.getDay();
  return ((e = n >= 4 || n === 0 ? hf(e) : hf.ceil(e)), W(e.getFullYear() % 1e4, t, 4));
}
function Ap(e) {
...
function Pp(e, t) {
  return W(1 + cf.count(kf(e), e), t, 3);
}
function Fp(e, t) {
...
function Vp(e, t) {
  return W(yf.count(kf(e) - 1, e), t, 2);
}
function Hp(e) {
  var t = e.getUTCDay();
...
function Up(e, t) {
  return ((e = Hp(e)), W(Cf.count(kf(e), e) + (kf(e).getUTCDay() === 4), t, 2));
}
function Wp(e) {
  return e.getUTCDay();
}
function Gp(e, t) {
  return W(bf.count(kf(e) - 1, e), t, 2);
}
function Kp(e, t) {
  return W(e.getUTCFullYear() % 100, t, 2);
}
function qp(e, t) {
  return ((e = Hp(e)), W(e.getUTCFullYear() % 100, t, 2));
}
function Jp(e, t) {
...
function Yp(e, t) {
  var n = e.getUTCDay();
  return ((e = n >= 4 || n === 0 ? Cf(e) : Cf.ceil(e)), W(e.getUTCFullYear() % 1e4, t, 4));
}
function Xp() {
  return `+0000`;
}
...
function rm(e) {
  return ((em = Rf(e)), (tm = em.format), em.parse, (nm = em.utcFormat), em.utcParse, em);
}
function im(e) {
  return new Date(e);
}
...
function om(e, t, n, r, i, a, o, s, c, l) {
  ...
  return (
    ...
    (u.copy = function () {
      return Vu(u, om(e, t, n, r, i, a, o, s, c, l));
    }),
    u
  );
}
function sm() {
  return xl.apply(
    om(Nf, Pf, Of, Ef, df, sf, af, nf, tf, tm).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]),
    arguments,
  );
}
function cm() {
  return xl.apply(
    om(jf, Mf, kf, Df, yf, cf, of, rf, tf, nm).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)]),
    arguments,
  );
}
function lm() {
...
function dm() {
  ...
  return (
    ...
    Sl.apply(e, arguments)
  );
}
function fm() {
  var e = Dd(lm()).domain([1, 10]);
  return (
    (e.copy = function () {
...
function gm() {
  var e = [],
    t = Iu;
  function n(n) {
    if (n != null && !isNaN((n = +n))) return t(($c(e, n, 1) - 1) / (e.length - 1));
  }
  return (
    (n.domain = function (t) {
      if (!arguments.length) return e.slice();
    ...
    (n.quantiles = function (t) {
      return Array.from({ length: t + 1 }, (n, r) => vl(e, r / t));
    }),
    (n.copy = function () {
      return gm(t).domain(e);
    }),
    Sl.apply(n, arguments)
  );
}
function _m() {
  var e = 0,
  ...
  function m(e) {
    return function (t) {
      var n, r, i;
      return arguments.length ? (([n, r, i] = t), (l = Mu(e, [n, r, i])), p) : [l(0), l(0.5), l(1)];
    };
  }
  return (
    (p.range = m(Au)),
...
function eh(e) {
  return e === 0 ? 1 : Math.floor(new G.default(e).abs().log(10).toNumber()) + 1;
}
function th(e, t, n) {
...
function mh(e, t, n) {
  ...
  return t ? s : new G.default(Math.ceil(s));
}
function hh(e, t, n) {
  var r = 1,
    i = new G.default(e);
  if (!i.isint() && n) {
    var a = Math.abs(e);
    a < 1
      ? ((r = new G.default(10).pow(nh.getDigitCount(e) - 1)),
  ...
  return Zm(
    Xm(function (e) {
      return i.add(new G.default(e - o).mul(r)).toNumber();
    }),
    Ym,
  )(0, t);
}
function gh(e, t, n, r) {
  ...
  if (!Number.isFinite((t - e) / (n - 1)))
    return { step: new G.default(0), tickMin: new G.default(0), tickMax: new G.default(0) };
  var a = mh(new G.default(t).sub(e).div(n - 1), r, i),
    o;
  e <= 0 && t >= 0
    ? (o = new G.default(0))
    : ((o = new G.default(e).add(t).div(2)), (o = o.sub(new G.default(o).mod(a))));
  var s = Math.ceil(o.sub(e).div(a).toNumber()),
    c = Math.ceil(new G.default(t).sub(o).div(a).toNumber()),
    l = s + c + 1;
  return l > n
    ? gh(e, t, n, r, i + 1)
    : (l < n && ((c = t > 0 ? c + (n - l) : c), (s = t > 0 ? s : s + (n - l))),
      {
        step: a,
        tickMin: o.sub(new G.default(s).mul(a)),
        tickMax: o.add(new G.default(c).mul(a)),
      });
}
function _h(e) {
  var t = sh(e, 2),
  ...
  var d = gh(c, l, o, a),
    ...
    p = d.tickMin,
    m = d.tickMax,
    h = nh.rangeStep(p, m.add(new G.default(0.1).mul(f)), f);
  return n > r ? Qm(h) : h;
}
function vh(e, t) {
  var n = sh(e, 2),
  ...
  if (s === c) return [s];
  var l = Math.max(t, 2),
    u = mh(new G.default(c).sub(s).div(l - 1), a, 0),
    d = [].concat(
      rh(nh.rangeStep(new G.default(s), new G.default(c).sub(new G.default(0.99).mul(u)), u)),
      [c],
    );
  return r > i ? Qm(d) : d;
}
...
var eg = function (e) {
  ...
  return Xh(Xh(Xh({}, s), Va.getWithHeight(a, r)), {}, { payload: c, item: a });
};
function tg(e) {
  "@babel/helpers - typeof";
  return (
...
var mg = function (e) {
  ...
  vg = function (e, t, n, r) {
    ...
    if (s) {
      ...
      if ((p === `vertical` || (p === `horizontal` && f === `middle`)) && d !== `center` && I(e[d]))
        return K(K({}, e), {}, lg({}, d, e[d] + (l || 0)));
      if ((p === `horizontal` || (p === `vertical` && d === `center`)) && f !== `middle` && I(e[f]))
        return K(K({}, e), {}, lg({}, f, e[f] + (u || 0)));
    }
    return e;
  },
  yg = function (e, t, n) {
  ...
  bg = function (e, t, n, r, i) {
    var a = t.props.children,
      o = yt(a, qh).filter(function (e) {
        return yg(r, i, e.props.direction);
      });
    if (o && o.length) {
  ...
  Sg = function (e, t, n, r, i) {
    var a = t.map(function (t) {
      var a = t.props.dataKey;
      return (n === `number` && a && bg(e, t, a, r)) || pg(e, a, n, i);
    });
    if (n === `number`)
      return a.reduce(
        function (e, t) {
  ...
  Og = function (e, t, n) {
    ...
    if (r === `auto`)
      return a === `radial` && o === `radiusAxis`
        ? { scale: Tl(), realScaleType: `band` }
        : a === `radial` && o === `angleAxis`
          ? { scale: gd(), realScaleType: `linear` }
          : i === `category` &&
              t &&
              (t.indexOf(`LineChart`) >= 0 ||
                t.indexOf(`AreaChart`) >= 0 ||
                (t.indexOf(`ComposedChart`) >= 0 && !n))
            ? { scale: Dl(), realScaleType: `point` }
            : i === `category`
              ? { scale: Tl(), realScaleType: `band` }
              : { scale: gd(), realScaleType: `linear` };
    if ((0, Ie.default)(r)) {
      var s = `scale${(0, vr.default)(r)}`;
      return { scale: (Cm[s] || Dl)(), realScaleType: Cm[s] ? s : `point` };
    }
    return (0, R.default)(r) ? { scale: r } : { scale: Dl(), realScaleType: `point` };
  },
  kg = 1e-4,
  Ag = function (e) {
    var t = e.domain();
    if (!(!t || t.length <= 2)) {
      var n = t.length,
        r = e.range(),
        i = Math.min(r[0], r[1]) - kg,
        a = Math.max(r[0], r[1]) + kg,
        o = e(t[0]),
        s = e(t[n - 1]);
...
function Lg(e) {
  ...
  var c = fg(i, (0, F.default)(o) ? t.dataKey : o);
...
var Rg = function (e) {
    ...
    var s = fg(a, t.dataKey, t.domain[o]);
  ...
  Kg = function (e, t, n) {
    ...
    if (e && t && t.length >= 2) {
      for (
        var i = (0, fo.default)(t, function (e) {
            return e.coordinate;
          }),
          a = 1 / 0,
          o = 1,
...
function Zg(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = arguments[t] == null ? {} : arguments[t];
    t % 2
      ? Xg(Object(n), !0).forEach(function (t) {
          Qg(e, t, n[t]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(n))
        : Xg(Object(n)).forEach(function (t) {
            Object.defineProperty(e, t, Object.getOwnPropertyDescriptor(n, t));
          });
  }
  return e;
...
function $g(e) {
  var t = e_(e, `string`);
  return Yg(t) == `symbol` ? t : t + ``;
}
function e_(e, t) {
  if (Yg(e) != `object` || !e) return e;
  var n = e[Symbol.toPrimitive];
  if (n !== void 0) {
    var r = n.call(e, t || `default`);
...
var t_ = Math.PI / 180,
  ...
  r_ = function (e, t, n, r) {
    return { x: e + Math.cos(-t_ * r) * n, y: t + Math.sin(-t_ * r) * n };
  },
  i_ = function (e, t) {
    var n = e.x,
      r = e.y,
  ...
  a_ = function (e, t) {
    var n = e.x,
      ...
      i = t.cx,
      a = t.cy,
      o = i_({ x: n, y: r }, { x: i, y: a });
    if (o <= 0) return { radius: o };
    var s = (n - i) / o,
      c = Math.acos(s);
    return (r > a && (c = 2 * Math.PI - c), { radius: o, angle: n_(c), angleInRadian: c });
  },
  o_ = function (e) {
    var t = e.startAngle,
      n = e.endAngle,
  ...
  c_ = function (e, t) {
    ...
    return p ? Zg(Zg({}, t), {}, { radius: a, angle: s_(f, t) }) : null;
  };
function l_(e) {
  "@babel/helpers - typeof";
  return (
...
function p_(e, t) {
  if (e) {
    ...
    if ((n === `Object` && e.constructor && (n = e.constructor.name), n === `Map` || n === `Set`))
      return Array.from(e);
    if (n === `Arguments` || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return g_(e, t);
  }
}
function m_(e) {
  if ((typeof Symbol < `u` && e[Symbol.iterator] != null) || e[`@@iterator`] != null)
...
var w_ = function (e) {
  ...
  E_ = function (e, t, n) {
    ...
    return P.createElement(
      `text`,
      C_({}, n, { dominantBaseline: `central`, className: a(`recharts-radial-bar-label`, s) }),
  ...
  O_ = function (e) {
    ...
    if (i === `top`)
      return q(
        q({}, { x: o + c / 2, y: s - u * r, textAnchor: `middle`, verticalAnchor: f }),
        n ? { height: Math.max(s - n.y, 0), width: c } : {},
      );
    if (i === `bottom`)
      return q(
        q({}, { x: o + c / 2, y: s + l + d, textAnchor: `middle`, verticalAnchor: p }),
        n ? { height: Math.max(n.y + n.height - (s + l), 0), width: c } : {},
      );
    if (i === `left`) {
      var v = { x: o - h, y: s + l / 2, textAnchor: g, verticalAnchor: `middle` };
      return q(q({}, v), n ? { width: Math.max(v.x - n.x, 0), height: l } : {});
    }
    if (i === `right`) {
      var y = { x: o + c + h, y: s + l / 2, textAnchor: _, verticalAnchor: `middle` };
      return q(q({}, y), n ? { width: Math.max(n.x + n.width - y.x, 0), height: l } : {});
    }
    var b = n ? { width: c, height: l } : {};
    return i === `insideLeft`
      ? q({ x: o + h, y: s + l / 2, textAnchor: _, verticalAnchor: `middle` }, b)
      : i === `insideRight`
        ? q({ x: o + c - h, y: s + l / 2, textAnchor: g, verticalAnchor: `middle` }, b)
        : i === `insideTop`
          ? q({ x: o + c / 2, y: s + d, textAnchor: `middle`, verticalAnchor: p }, b)
          : i === `insideBottom`
            ? q({ x: o + c / 2, y: s + l - d, textAnchor: `middle`, verticalAnchor: f }, b)
            : i === `insideTopLeft`
              ? q({ x: o + h, y: s + d, textAnchor: _, verticalAnchor: p }, b)
              : i === `insideTopRight`
                ? q({ x: o + c - h, y: s + d, textAnchor: g, verticalAnchor: p }, b)
                : i === `insideBottomLeft`
                  ? q({ x: o + h, y: s + l - d, textAnchor: _, verticalAnchor: f }, b)
                  : i === `insideBottomRight`
                    ? q({ x: o + c - h, y: s + l - d, textAnchor: g, verticalAnchor: f }, b)
...
function A_(e) {
  ...
  var h = k_(o),
    g = z(i, !0);
  if (h && (s === `insideStart` || s === `insideEnd` || s === `end`)) return E_(i, m, g);
  var _ = h ? D_(i) : O_(i);
  return P.createElement(Gc, C_({ className: a(`recharts-label`, f) }, g, _, { breakAll: p }), m);
}
A_.displayName = `Label`;
var j_ = function (e) {
    var t = e.cx,
      n = e.cy,
      r = e.angle,
  ...
  M_ = function (e, t) {
    return e
      ? e === !0
        ? P.createElement(A_, { key: `label-implicit`, viewBox: t })
        : L(e)
          ? P.createElement(A_, { key: `label-implicit`, viewBox: t, value: e })
          : (0, P.isValidElement)(e)
            ? e.type === A_
              ? (0, P.cloneElement)(e, { key: `label-implicit`, viewBox: t })
              : P.createElement(A_, { key: `label-implicit`, content: e, viewBox: t })
            : (0, R.default)(e)
              ? P.createElement(A_, { key: `label-implicit`, content: e, viewBox: t })
              : (0, Ze.default)(e)
                ? P.createElement(A_, C_({ viewBox: t }, e, { key: `label-implicit` }))
                : null
      : null;
  };
((A_.parseViewBox = j_),
  (A_.renderCallByParent = function (e, t) {
    var n = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : !0;
    if (!e || (!e.children && n && !e.label)) return null;
    var r = e.children,
      i = j_(e),
      a = yt(r, A_).map(function (e, n) {
        return (0, P.cloneElement)(e, { viewBox: t || i, key: `label-${n}` });
      });
    return n ? [M_(e.label, t || i)].concat(d_(a)) : a;
  }));
var N_ = t(
  n((e, t) => {
    function n(e) {
...
var F_ = [`valueAccessor`],
  I_ = [`data`, `dataKey`, `clockWise`, `id`, `textBreakAll`];
function L_(e) {
  return V_(e) || B_(e) || z_(e) || R_();
}
function R_() {
  throw TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
function z_(e, t) {
  if (e) {
    ...
    if ((n === `Object` && e.constructor && (n = e.constructor.name), n === `Map` || n === `Set`))
      return Array.from(e);
    if (n === `Arguments` || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return H_(e, t);
  }
}
function B_(e) {
  if ((typeof Symbol < `u` && e[Symbol.iterator] != null) || e[`@@iterator`] != null)
...
function G_(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = arguments[t] == null ? {} : arguments[t];
    t % 2
      ? W_(Object(n), !0).forEach(function (t) {
          K_(e, t, n[t]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(n))
        : W_(Object(n)).forEach(function (t) {
            Object.defineProperty(e, t, Object.getOwnPropertyDescriptor(n, t));
          });
  }
  return e;
...
var Z_ = function (e) {
  return Array.isArray(e.value) ? (0, N_.default)(e.value) : e.value;
};
function Q_(e) {
  ...
  return !i || !i.length
    ...
    : P.createElement(
        ...
        i.map(function (e, t) {
          var r = (0, F.default)(a) ? n(e, t) : fg(e && e.payload, a),
          ...
          return P.createElement(
            ...
            U_({}, z(e, !0), l, i, {
              ...
              value: r,
              textBreakAll: c,
              viewBox: A_.parseViewBox((0, F.default)(o) ? e : G_(G_({}, e), {}, { clockWise: o })),
              key: `label-${t}`,
              index: t,
            }),
          );
...
Q_.displayName = `LabelList`;
function $_(e, t) {
  return e
    ? e === !0
      ? P.createElement(Q_, { key: `labelList-implicit`, data: t })
      : P.isValidElement(e) || (0, R.default)(e)
        ? P.createElement(Q_, { key: `labelList-implicit`, data: t, content: e })
        : (0, Ze.default)(e)
          ? P.createElement(Q_, U_({ data: t }, e, { key: `labelList-implicit` }))
          : null
    : null;
}
function ev(e, t) {
  ...
  if (!e || (!e.children && n && !e.label)) return null;
  var r = e.children,
    i = yt(r, Q_).map(function (e, n) {
      return (0, P.cloneElement)(e, { data: t, key: `labelList-${n}` });
    });
  return n ? [$_(e.label, t)].concat(L_(i)) : i;
}
Q_.renderCallByParent = ev;
function tv(e) {
  "@babel/helpers - typeof";
  return (
    (tv =
...
var cv = function (e, t) {
  ...
  lv = function (e) {
    ...
    return {
      center: f,
      circleTangency: p,
      lineTangency: r_(t, n, l * Math.cos(u * t_), m),
      theta: u,
    };
  },
  uv = function (e) {
  ...
  dv = function (e) {
    var t = e.cx,
      ...
      l = e.endAngle,
      u = Be(l - c),
      d = lv({ cx: t, cy: n, radius: i, angle: c, sign: u, cornerRadius: a, cornerIsExternal: s }),
      f = d.circleTangency,
      p = d.lineTangency,
      m = d.theta,
      h = lv({ cx: t, cy: n, radius: i, angle: l, sign: -u, cornerRadius: a, cornerIsExternal: s }),
      g = h.circleTangency,
      _ = h.lineTangency,
      v = h.theta,
    ...
    if (y < 0)
      return o
        ...
        a${a},${a},0,0,1,${-a * 2},0
      `
        : uv({ cx: t, cy: n, innerRadius: r, outerRadius: i, startAngle: c, endAngle: l });
    var b = `M ${p.x},${p.y}
  ...
  pv = function (e) {
    var t = iv(iv({}, fv), e),
      ...
      d = t.endAngle,
      f = t.className;
    if (o < i || u === d) return null;
    var p = a(`recharts-sector`, f),
      m = o - i,
      h = Ge(s, m, 0, !0),
      g =
        h > 0 && Math.abs(u - d) < 360
          ...
          : uv({ cx: n, cy: r, innerRadius: i, outerRadius: o, startAngle: u, endAngle: d });
    return P.createElement(`path`, nv({}, z(t, !0), { className: p, d: g, role: `img` }));
  };
function mv(e) {
  "@babel/helpers - typeof";
  return (
...
var xv = {
  ...
  Dv = function (e) {
    ...
    var o = n && n.length ? Ev(e) : r;
    return P.createElement(
      `path`,
      hv({}, z(e, !1), ot(e), { className: a(`recharts-curve`, t), d: o, ref: i }),
    );
  },
  Ov = n((e, t) => {
  ...
  { getOwnPropertyNames: Av, getOwnPropertySymbols: jv } = Object,
...
function Iv(e) {
  return Av(e).concat(jv(e));
}
var Lv = Object.hasOwn || ((e, t) => Mv.call(e, t));
function Rv(e, t) {
...
var zv = `__v`,
  Bv = `__o`,
  Vv = `_owner`,
  { getOwnPropertyDescriptor: Hv, keys: Uv } = Object;
function Wv(e, t) {
  return e.byteLength === t.byteLength && ry(new Uint8Array(e), new Uint8Array(t));
}
function Gv(e, t, n) {
  let r = e.length;
...
function Qv(e, t, n) {
  ...
  for (; i-- > 0;) if (!ay(e, t, n, r[i])) return !1;
  return !0;
}
function $v(e, t, n) {
  let r = Iv(e),
    i = r.length;
  if (Iv(t).length !== i) return !1;
  let a, o, s;
  for (; i-- > 0;)
    if (
      ((a = r[i]),
...
function ay(e, t, n, r) {
  return (r === Vv || r === Bv || r === zv) && (e.$$typeof || t.$$typeof)
    ? !0
    : Lv(t, r) && n.equals(e[r], t[r], r, r, e, t, n);
}
...
function xy({
  ...
  return function (h, g, _) {
    ...
    let b = by.call(h);
    if (b === uy) return r(h, g, _);
    if (b === hy) return u(h, g, _);
    if (b === fy) return o(h, g, _);
    if (b === gy) return d(h, g, _);
    if (b === my) return typeof h.then != `function` && typeof g.then != `function` && c(h, g, _);
    if (b === yy) return p(h, g, _);
    if (b === dy) return i(h, g, _);
    if (b === sy) return c(h, g, _);
    if (vy[b]) return f(h, g, _);
    if (b === oy) return e(h, g, _);
    if (b === ly) return n(h, g, _);
    if (b === cy || b === py || b === _y) return l(h, g, _);
    if (m) {
      let e = m[b];
      if (!e) {
        let t = Fv(h);
...
function Sy({ circular: e, createCustomConfig: t, strict: n }) {
  let r = {
    areArrayBuffersEqual: Wv,
    areArraysEqual: n ? $v : Gv,
    areDataViewsEqual: Kv,
    areDatesEqual: qv,
    areErrorsEqual: Jv,
    areFunctionsEqual: Yv,
    areMapsEqual: n ? Nv(Xv, $v) : Xv,
    areNumbersEqual: Zv,
    areObjectsEqual: n ? $v : Qv,
    arePrimitiveWrappersEqual: ey,
    areRegExpsEqual: ty,
    areSetsEqual: n ? Nv(ny, $v) : ny,
    areTypedArraysEqual: n ? Nv(ry, $v) : ry,
    areUrlsEqual: iy,
...
function wy({ circular: e, comparator: t, createState: n, equals: r, strict: i }) {
  if (n)
    return function (a, o) {
...
(Ey({ strict: !0 }),
  Ey({ circular: !0 }),
  Ey({ circular: !0, strict: !0 }),
  Ey({ createInternalComparator: () => Rv }),
  Ey({ strict: !0, createInternalComparator: () => Rv }),
  Ey({ circular: !0, createInternalComparator: () => Rv }),
  Ey({ circular: !0, createInternalComparator: () => Rv, strict: !0 }));
function Ey(e = {}) {
  let { circular: t = !1, createInternalComparator: n, createState: r, strict: i = !1 } = e,
    a = xy(Sy(e));
  return wy({ circular: t, comparator: a, createState: r, equals: n ? n(a) : Cy(a), strict: i });
}
function Dy(e) {
...
function My(e, t) {
  if (e) {
    ...
    if ((n === `Object` && e.constructor && (n = e.constructor.name), n === `Map` || n === `Set`))
      return Array.from(e);
    if (n === `Arguments` || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return Ny(e, t);
  }
}
function Ny(e, t) {
  (t == null || t > e.length) && (t = e.length);
    ...
    r = function r(i) {
      if (!n) {
        if (Array.isArray(i)) {
          ...
          (r(o), Oy(r.bind(null, s)));
          return;
        }
        (ky(i) === `object` && ((e = i), t(e)), typeof i == `function` && i());
      }
    };
  return {
    stop: function () {
...
function Vy(e) {
  var t = Hy(e, `string`);
  return Ly(t) === `symbol` ? t : String(t);
}
function Hy(e, t) {
  if (Ly(e) !== `object` || e === null) return e;
  var n = e[Symbol.toPrimitive];
  if (n !== void 0) {
    var r = n.call(e, t || `default`);
    if (Ly(r) !== `object`) return r;
    throw TypeError(`@@toPrimitive must return a primitive value.`);
  }
  return (t === `string` ? String : Number)(e);
}
    ...
    var s = sb(t, r),
      ...
      d = function (e) {
        for (var t = e > 1 ? 1 : e, n = t, r = 0; r < 8; ++r) {
          var i = s(n) - t,
            a = l(n);
          if (Math.abs(i - t) < ib || a < ib) return c(n);
          n = u(n - i / a);
        }
        return c(n);
      };
    ...
    var e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {},
      ...
      s = function (e, t, r) {
        var a = r + ((-(e - t) * n - r * i) * o) / 1e3,
          s = (r * o) / 1e3 + e;
        return Math.abs(s - t) < ib && Math.abs(a) < ib ? [t, 0] : [s, a];
      };
    ...
    if (typeof e == `string`)
      switch (e) {
        ...
        case `spring`:
          return ub();
        default:
          if (e.split(`(`)[0] === `cubic-bezier`) return lb(e);
      }
...
function vb(e) {
  for (var t = 1; t < arguments.length; t++) {
    var n = arguments[t] == null ? {} : arguments[t];
    t % 2
      ? _b(Object(n), !0).forEach(function (t) {
          yb(e, t, n[t]);
        })
      : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(n))
        : _b(Object(n)).forEach(function (t) {
            Object.defineProperty(e, t, Object.getOwnPropertyDescriptor(n, t));
          });
  }
  return e;
...
function wb(e, t) {
  if (e) {
    ...
    if ((n === `Object` && e.constructor && (n = e.constructor.name), n === `Map` || n === `Set`))
      return Array.from(e);
    if (n === `Arguments` || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return Tb(e, t);
  }
}
function Tb(e, t) {
  (t == null || t > e.length) && (t = e.length);
...
var Ob = function (e, t, n) {
  ...
  Ab = function e(t, n, r) {
    var i = Ky(function (e, n) {
      if (kb(n)) {
        var r = Sb(t(n.from, n.to, n.velocity), 2),
          i = r[0],
          a = r[1];
      ...
      ? Ky(function (e, t) {
          return kb(t)
            ? vb(
                vb({}, t),
                {},
                { velocity: Ob(t.velocity, i[e].velocity, r), from: Ob(t.from, i[e].from, r) },
              )
            : t;
        }, n)
      : e(t, i, r - 1);
  },
  jb = function (e, t, n, r, i) {
    var a = Uy(e, t),
      o = a.reduce(function (n, r) {
        return vb(vb({}, n), {}, yb({}, r, [e[r], t[r]]));
      }, {}),
      s = a.reduce(function (n, r) {
        return vb(vb({}, n), {}, yb({}, r, { from: e[r], velocity: 0, to: t[r] }));
      }, {}),
      c = -1,
      l,
      u,
      ...
      f = function () {
        return Ky(function (e, t) {
          return t.from;
        }, s);
      },
      p = function () {
        return !Object.values(s).filter(kb).length;
      };
    return (
      (d = n.isStepper
        ? function (r) {
        ...
        : function (a) {
            ...
            var s = (a - u) / r,
              l = Ky(function (e, t) {
                return Ob.apply(void 0, pb(t).concat([n(s)]));
              }, o);
            if ((i(vb(vb(vb({}, e), t), l)), s < 1)) c = requestAnimationFrame(d);
            else {
              var f = Ky(function (e, t) {
                return Ob.apply(void 0, pb(t).concat([n(1)]));
              }, o);
              i(vb(vb(vb({}, e), t), f));
            }
          }),
...
function Kb(e, t) {
  for (var n = 0; n < t.length; n++) {
    ...
    ((r.enumerable = r.enumerable || !1),
      (r.configurable = !0),
      `value` in r && (r.writable = !0),
      Object.defineProperty(e, Jb(r.key), r));
  }
}
function qb(e, t, n) {
  return (
...
function Jb(e) {
  var t = Yb(e, `string`);
  return Mb(t) === `symbol` ? t : String(t);
}
function Yb(e, t) {
  if (Mb(e) !== `object` || e === null) return e;
  var n = e[Symbol.toPrimitive];
  if (n !== void 0) {
    var r = n.call(e, t || `default`);
...
function $b(e, t) {
  if (t && (Mb(t) === `object` || typeof t == `function`)) return t;
  if (t !== void 0) throw TypeError(`Derived constructors may only return object or undefined`);
  return ex(e);
}
function ex(e) {
...
var rx = (function (e) {
  ...
  function n(e, r) {
    ...
    var a = i.props,
      ...
      f = a.duration;
    if (
      ((i.handleStyleChange = i.handleStyleChange.bind(ex(i))),
      (i.changeStyle = i.changeStyle.bind(ex(i))),
      !o || f <= 0)
    )
      return ((i.state = { style: {} }), typeof d == `function` && (i.state = { style: l }), $b(i));
    if (u && u.length) i.state = { style: u[0].style };
    else if (c) {
      if (typeof d == `function`) return ((i.state = { style: c }), $b(i));
      i.state = { style: s ? Wb({}, s, c) : c };
    } else i.state = { style: {} };
    return i;
  }
  return (
    qb(n, [
      ...
      },
      {
        ...
        value: function (e) {
          ...
          if (r) {
            if (!n) {
              var l = { style: i ? Wb({}, i, o) : o };
              this.state && c && ((i && c[i] !== o) || (!i && c !== o)) && this.setState(l);
              return;
            }
            if (!(Ty(e.to, o) && e.canBegin && e.isActive)) {
              var u = !e.canBegin || !e.isActive;
              (this.manager && this.manager.stop(), this.stopJSAnimation && this.stopJSAnimation());
              var d = u || a ? s : e.to;
              if (this.state && c) {
                var f = { style: i ? Wb({}, i, d) : d };
                ((i && c[i] !== d) || (!i && c !== d)) && this.setState(f);
              }
              this.runAnimation(Ub(Ub({}, this.props), {}, { from: d, begin: 0 }));
            }
          }
        },
      },
      ...
      },
      {
        ...
        value: function (e) {
          var t = this,
            ...
            l = jb(n, r, db(a), i, this.changeStyle);
          this.manager.start([
            c,
            o,
            function () {
              ...
              Ib(
                n.reduce(
                  function (e, r, i) {
                    ...
                    var p = qy(f, a, s),
                      m = Ub(Ub(Ub({}, d.style), c), {}, { transition: p });
                    return [].concat(Ib(e), [m, a, u]).filter(Wy);
                  },
                  [o, Math.max(c, r)],
                ),
              ),
      ...
      },
      {
        ...
        value: function (e) {
          ...
          var d = r ? Wb({}, r, i) : i,
            f = qy(Object.keys(d), n, a);
          u.start([o, t, Ub(Ub({}, d), {}, { transition: f }), n, s]);
        },
      },
      {
        key: `render`,
        value: function () {
          ...
          var s = function (e) {
            ...
            return (0, P.cloneElement)(
              e,
              Ub(Ub({}, i), {}, { style: Ub(Ub({}, r), o), className: a }),
            );
          };
          return a === 1
            ? s(P.Children.only(t))
...
((rx.displayName = `Animate`),
  ...
  (rx.propTypes = {
    from: J.default.oneOfType([J.default.object, J.default.string]),
    to: J.default.oneOfType([J.default.object, J.default.string]),
    attributeName: J.default.string,
    duration: J.default.number,
    begin: J.default.number,
    easing: J.default.oneOfType([J.default.string, J.default.func]),
    steps: J.default.arrayOf(
      J.default.shape({
        duration: J.default.number.isRequired,
        style: J.default.object.isRequired,
        easing: J.default.oneOfType([
          J.default.oneOf([`ease`, `ease-in`, `ease-out`, `ease-in-out`, `linear`]),
          J.default.func,
        ]),
        properties: J.default.arrayOf(`string`),
        onAnimationEnd: J.default.func,
      }),
    ),
    children: J.default.oneOfType([J.default.node, J.default.func]),
    isActive: J.default.bool,
    canBegin: J.default.bool,
    onAnimationEnd: J.default.func,
    shouldReAnimate: J.default.bool,
    onAnimationStart: J.default.func,
    onAnimationReStart: J.default.func,
  }));
var ix = rx;
function ax(e) {
  "@babel/helpers - typeof";
      ...
      ? P.createElement(
          ...
          function (e) {
            ...
            return P.createElement(
              ...
              P.createElement(
                `path`,
                ox({}, z(t, !0), { className: v, d: vx(o, s, r, a, d), ref: n }),
              ),
            );
          },
        )
      : P.createElement(`path`, ox({}, z(t, !0), { className: v, d: vx(s, c, l, u, d) }));
  };
function Sx() {
  return (
    (Sx = Object.assign
...
var Cx = function (e) {
  var t = e.cx,
    ...
    o = a(`recharts-dot`, i);
  return t === +t && n === +n && r === +r
    ? P.createElement(`circle`, Sx({}, z(e, !1), ot(e), { className: o, cx: t, cy: n, r }))
    : null;
};
function wx(e) {
  "@babel/helpers - typeof";
...
var Tx = [`x`, `y`, `top`, `left`, `width`, `height`, `className`];
function Ex() {
  return (
    (Ex = Object.assign
      ? Object.assign.bind()
...
function Ax(e) {
  var t = jx(e, `string`);
  return wx(t) == `symbol` ? t : t + ``;
}
function jx(e, t) {
  if (wx(e) != `object` || !e) return e;
  var n = e[Symbol.toPrimitive];
  if (n !== void 0) {
    var r = n.call(e, t || `default`);
    if (wx(r) != `object`) return r;
    throw TypeError(`@@toPrimitive must return a primitive value.`);
  }
  return (t === `string` ? String : Number)(e);
}
...
var Px = function (e, t, n, r, i, a) {
  ...
  Fx = function (e) {
    var t = e.x,
      ...
      m = e.className,
      h = Mx(e, Tx),
      g = Ox({ x: n, y: i, top: s, left: l, width: d, height: p }, h);
    return !I(n) || !I(i) || !I(d) || !I(p) || !I(s) || !I(l)
      ? null
      : P.createElement(
          `path`,
          Ex({}, z(g, !0), { className: a(`recharts-cross`, m), d: Px(n, i, d, p, s, l) }),
        );
  },
  Ix = n((e, t) => {
    t.exports = Pi()(Object.getPrototypeOf, Object);
  }),
  Lx = n((e, t) => {
    var n = v(),
      r = Ix(),
...
function Gx(e, t) {
  if (e) {
    ...
    if ((n === `Object` && e.constructor && (n = e.constructor.name), n === `Map` || n === `Set`))
      return Array.from(e);
    if (n === `Arguments` || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return Kx(e, t);
  }
}
function Kx(e, t) {
  (t == null || t > e.length) && (t = e.length);
...
function Qx(e) {
  var t = $x(e, `string`);
  return Vx(t) == `symbol` ? t : t + ``;
}
function $x(e, t) {
  if (Vx(e) != `object` || !e) return e;
  var n = e[Symbol.toPrimitive];
  if (n !== void 0) {
    var r = n.call(e, t || `default`);
    if (Vx(r) != `object`) return r;
    throw TypeError(`@@toPrimitive must return a primitive value.`);
  }
  return (t === `string` ? String : Number)(e);
}
var eS = function (e, t, n, r, i) {
    var a = n - r,
      o = `M ${e},${t}`;
    return (
      (o += `L ${e + n},${t}`),
  ...
  nS = function (e) {
    ...
    if (s !== +s || c !== +c || l !== +l || u !== +u || d !== +d || (l === 0 && u === 0) || d === 0)
      return null;
    var _ = a(`recharts-trapezoid`, f);
    return g
      ? P.createElement(
          ix,
          {
          ...
          function (e) {
            ...
            return P.createElement(
              ...
              P.createElement(
                `path`,
                Hx({}, z(t, !0), { className: _, d: eS(s, c, r, a, o), ref: n }),
              ),
            );
          },
        )
      : P.createElement(
          `g`,
          null,
          P.createElement(`path`, Hx({}, z(t, !0), { className: _, d: eS(s, c, l, u, d) })),
        );
  },
  rS = [`option`, `shapeType`, `propTransformer`, `activeClassName`, `isActive`];
function iS(e) {
  "@babel/helpers - typeof";
  return (
    (iS =
...
function mS(e) {
  ...
  switch (t) {
    case `rectangle`:
      return P.createElement(xx, n);
    case `trapezoid`:
      return P.createElement(nS, n);
    case `sector`:
      return P.createElement(pv, n);
    case `symbols`:
      if (pS(t, n)) return P.createElement(Pr, n);
      break;
    default:
      return null;
  }
...
function gS(e) {
  var t = e.option,
    ...
    c = aS(e, rS),
    l;
  if ((0, P.isValidElement)(t)) l = (0, P.cloneElement)(t, cS(cS({}, c), hS(t)));
  else if ((0, R.default)(t)) l = t(c);
  else if ((0, zx.default)(t) && !(0, Bx.default)(t)) {
    var u = i(t, c);
    l = P.createElement(mS, { shapeType: n, elementProps: u });
  } else {
    var d = c;
    l = P.createElement(mS, { shapeType: n, elementProps: d });
  }
...
function CS(e, t) {
  var n;
  return (_S(e, t) ? (n = bS) : vS(e, t) ? (n = xS) : yS(e, t) && (n = SS), n);
}
function wS(e, t) {
  var n;
  return (
    _S(e, t) ? (n = `trapezoids`) : vS(e, t) ? (n = `sectors`) : yS(e, t) && (n = `points`),
    n
  );
}
function TS(e, t) {
...
var LS = [`Webkit`, `Moz`, `O`, `ms`],
  RS = function (e, t) {
    ...
    var n = e.replace(/(\w)/, function (e) {
      ...
      r = LS.reduce(function (e, r) {
        return NS(NS({}, e), {}, PS({}, r + n, t));
      }, {});
    return ((r[e] = t), r);
  };
function zS(e) {
...
function KS(e, t, n) {
  return (
    (t = XS(t)),
    qS(e, YS() ? Reflect.construct(t, n || [], XS(e).constructor) : t.apply(e, n))
  );
}
function qS(e, t) {
  ...
  iC = (function (e) {
    function t(e) {
      ...
      return (
        ...
        $S(n, `handleLeaveWrapper`, function () {
          (n.state.isTravellerMoving || n.state.isSlideMoving) &&
            (n.leaveTimer = window.setTimeout(n.handleDragEnd, n.props.leaveTimeOut));
        }),
        $S(n, `handleEnterSlideOrTraveller`, function () {
          n.setState({ isTextActive: !0 });
        }),
        $S(n, `handleLeaveSlideOrTraveller`, function () {
          n.setState({ isTextActive: !1 });
        }),
        $S(n, `handleSlideDragStart`, function (e) {
          var t = rC(e) ? e.changedTouches[0] : e;
      ...
      GS(
        ...
        [
          ...
          },
          {
            ...
            value: function (e, t) {
              var n = rC(t) ? t.changedTouches[0] : t;
              (this.setState({
                isSlideMoving: !1,
                isTravellerMoving: !0,
                movingTravellerId: e,
          ...
          },
          {
            ...
            value: function (e) {
              ...
              this.setState($S($S({}, r, o + h), `brushMoveStartX`, e.pageX), function () {
                d && y() && d(g);
              });
            },
          },
          ...
          },
          {
            ...
            value: function (e, n) {
              var r = this,
                ...
                m = HS(HS({}, z(this.props, !1)), {}, { x: p, y: a, width: o, height: s }),
          ...
          },
          {
            ...
            value: function () {
              ...
              if (!t || !t.length || !I(i) || !I(o) || !I(s) || !I(c) || s <= 0 || c <= 0)
                return null;
              var _ = a(`recharts-brush`, n),
                v = P.Children.count(r) === 1,
                y = RS(`userSelect`, `none`);
              return P.createElement(
                B,
                {
                  className: _,
            ...
            value: function (e, t) {
              ...
              if (n !== t.prevData || o !== t.prevUpdateId)
                return HS(
                  ...
                  n && n.length
                    ? nC({ data: n, width: r, x: i, travellerWidth: a, startIndex: s, endIndex: c })
...
function EC(e) {
  return P.createElement(
    gS,
    _C({ shapeType: `rectangle`, propTransformer: TC, activeClassName: `recharts-active-bar` }, e),
  );
}
var DC = function (e) {
    var t = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0;
...
function IC(e, t) {
  for (var n = 0; n < t.length; n++) {
    ...
    ((r.enumerable = r.enumerable || !1),
      (r.configurable = !0),
      `value` in r && (r.writable = !0),
      Object.defineProperty(e, KC(r.key), r));
  }
}
function LC(e, t, n) {
  return (
...
function RC(e, t, n) {
  return (
    (t = HC(t)),
    zC(e, VC() ? Reflect.construct(t, n || [], HC(e).constructor) : t.apply(e, n))
  );
}
function zC(e, t) {
...
var JC = (function (e) {
  function t() {
    ...
    return (
      ...
      GC(e, `state`, { isAnimationFinished: !1 }),
      GC(e, `id`, We(`recharts-bar-`)),
      GC(e, `handleAnimationEnd`, function () {
        var t = e.props.onAnimationEnd;
        (e.setState({ isAnimationFinished: !0 }), t && t());
      }),
      GC(e, `handleAnimationStart`, function () {
          ...
          value: function (e) {
            ...
            return (
              ...
              e.map(function (e, n) {
                ...
                return P.createElement(
                  B,
                  NC({ className: `recharts-bar-rectangle` }, ct(t.props, e, n), {
                    key: `rectangle-${e?.x}-${e?.y}-${e?.value}-${n}`,
                  }),
                  P.createElement(EC, u),
                );
              })
            );
          },
                ...
                var i = t.t,
                  a = n.map(function (e, t) {
                    ...
                    if (n) {
                      ...
                      return Y(Y({}, e), {}, { x: a(i), y: o(i), width: s(i), height: c(i) });
                    }
                    if (r === `horizontal`) {
                      var u = Je(0, e.height)(i);
                      return Y(Y({}, e), {}, { y: e.y + e.height - u, height: u });
                    }
                    var d = Je(0, e.width)(i);
                    return Y(Y({}, e), {}, { width: d });
                  });
        ...
        },
        {
          ...
          value: function () {
            ...
            return n.map(function (t, n) {
              ...
              if (!o) return null;
              var c = Y(
                Y(Y(Y(Y({}, s), {}, { fill: `#eee` }, o), a), ct(e.props, t, n)),
                {},
                {
          ...
          value: function (e, t) {
            ...
            var l = o === `vertical` ? r[0].height / 2 : r[0].width / 2,
              u = function (e, t) {
                ...
                return { x: e.x, y: e.y, value: n, errorVal: fg(e, t) };
              },
        ...
        },
        {
          ...
          value: function () {
            ...
            return P.createElement(
              ...
              (!d || m) && Q_.renderCallByParent(this.props, n),
            );
          },
        },
      ],
...
((kC = JC),
  ...
  GC(JC, `getComposedData`, function (e) {
    var t = e.props,
      n = e.item,
      r = e.barPosition,
      i = e.bandSize,
    ...
    var m = t.layout,
      ...
      g = h === void 0 ? n.props : Y(Y({}, h), n.props),
      _ = g.dataKey,
      v = g.children,
      y = g.minPointSize,
      b = m === `horizontal` ? o : a,
    ...
    return Y(
      {
        data: d.map(function (e, t) {
          var r, d, f, h, g, v;
          l ? (r = Mg(l[u + t], x)) : ((r = fg(e, _)), Array.isArray(r) || (r = [S, r]));
          var b = DC(y, kC.defaultProps.minPointSize)(r[1], t);
          if (m === `horizontal`) {
            var w = [o.scale(r[0]), o.scale(r[1])],
              T = w[0],
              E = w[1];
            ((d = Rg({ axis: a, ticks: s, bandSize: i, offset: p.offset, entry: e, index: t })),
              (f = E ?? T ?? void 0),
              (h = p.size));
            var D = T - E;
            if (
            ...
            if (
              ((d = A),
              (f = Rg({ axis: o, ticks: c, bandSize: i, offset: p.offset, entry: e, index: t })),
              (h = j - A),
              (g = p.size),
          ...
          return Y(
            ...
            {},
            { tooltipPayload: [Jg(n, e)], tooltipPosition: { x: d + h / 2, y: f + g / 2 } },
          );
        }),
        layout: m,
      },
...
var iw = function (e, t, n, r, i) {
    ...
    return l.reduce(function (a, o) {
      ...
      var A = Og(c, i, d),
        j = A.scale,
        M = A.realScaleType;
      (j.domain(f).range(y), Ag(j));
      var N = Ig(j, ew(ew({}, c), {}, { realScaleType: M }));
      r === `xAxis`
  ...
  ow = function (e) {
    var t = e.x1,
      ...
      r = e.x2,
      i = e.y2;
    return aw({ x: t, y: n }, { x: r, y: i });
  },
  sw = (function () {
    function e(t) {
      (XC(this, e), (this.scale = t));
    }
    return QC(
      e,
      [
...
var cw = function (e) {
  var t = Object.keys(e).reduce(function (t, n) {
    return ew(ew({}, t), {}, tw({}, n, sw.create(e[n])));
  }, {});
  return ew(
    ew({}, t),
    {},
    {
      apply: function (e) {
        var n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {},
          r = n.bandAware,
          i = n.position;
        return (0, pC.default)(e, function (e, n) {
          return t[n].apply(e, { bandAware: r, position: i });
        });
      },
      isInRange: function (e) {
        return (0, mC.default)(e, function (e, n) {
...
var uw = function (e) {
    var t = e.width,
      n = e.height,
      r = (lw(arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 0) * Math.PI) / 180,
      i = Math.atan(n / t),
  ...
  gw = (0, P.createContext)(void 0),
  _w = (0, P.createContext)(void 0),
  vw = (0, P.createContext)(void 0),
  yw = (0, P.createContext)({}),
  bw = (0, P.createContext)(void 0),
  xw = (0, P.createContext)(0),
  Sw = (0, P.createContext)(0),
  Cw = function (e) {
    var t = e.state,
      n = t.xAxisMap,
      r = t.yAxisMap,
          ...
          P.createElement(
            ...
            P.createElement(
              ...
              P.createElement(
                xw.Provider,
                { value: c },
                P.createElement(Sw.Provider, { value: s }, o),
              ),
            ),
          ),
        ),
  ...
  ww = function () {
    return (0, P.useContext)(bw);
  },
  Tw = function (e) {
    var t = (0, P.useContext)(gw);
    t ?? Sh(!1);
    var n = t[e];
    return (n ?? Sh(!1), n);
  },
  Ew = function () {
    return Ke((0, P.useContext)(gw));
  },
  Dw = function () {
    var e = (0, P.useContext)(_w);
    return (
      (0, mw.default)(e, function (e) {
        return (0, mC.default)(e.domain, Number.isFinite);
      }) || Ke(e)
    );
  },
  Ow = function (e) {
    var t = (0, P.useContext)(_w);
    t ?? Sh(!1);
    var n = t[e];
    return (n ?? Sh(!1), n);
  },
  kw = function () {
    return (0, P.useContext)(vw);
  },
  Aw = function () {
    return (0, P.useContext)(yw);
  },
  jw = function () {
    return (0, P.useContext)(Sw);
  },
  Mw = function () {
    return (0, P.useContext)(xw);
  },
  Nw = t(oC());
function Pw(e) {
  "@babel/helpers - typeof";
...
function Iw(e, t) {
  for (var n = 0; n < t.length; n++) {
    ...
    ((r.enumerable = r.enumerable || !1),
      (r.configurable = !0),
      `value` in r && (r.writable = !0),
      Object.defineProperty(e, Jw(r.key), r));
  }
}
function Lw(e, t, n) {
  return (
...
function Rw(e, t, n) {
  return (
    (t = Hw(t)),
    zw(e, Vw() ? Reflect.construct(t, n || [], Hw(e).constructor) : t.apply(e, n))
  );
}
function zw(e, t) {
...
var rT = function (e, t) {
    return P.isValidElement(e)
      ...
      : (0, R.default)(e)
        ? e(t)
        : P.createElement(`line`, nT({}, t, { className: `recharts-reference-line-line` }));
  },
  iT = function (e, t, n, r, i, a, o, s, c) {
    ...
    if (n) {
      ...
      if (sC(c, `discard`) && !e.y.isInRange(m)) return null;
      var h = [
        { x: l + d, y: m },
        { x: l, y: m },
      ];
    ...
    if (t) {
      ...
      if (sC(c, `discard`) && !e.x.isInRange(_)) return null;
      var v = [
        { x: _, y: u + f },
        { x: _, y: u },
      ];
...
function aT(e) {
  ...
  var m = Xw(p, 2),
    ...
    b = v.y,
    x = Kw(
      Kw({ clipPath: sC(e, `hidden`) ? `url(#${l})` : void 0 }, z(e, !0)),
      {},
      { x1: g, y1: _, x2: y, y2: b },
    );
  return P.createElement(
    B,
    { className: a(`recharts-reference-line`, c) },
    rT(s, x),
    A_.renderCallByParent(e, ow({ x1: g, y1: _, x2: y, y2: b })),
  );
}
var oT = (function (e) {
  function t() {
    ...
    Lw(t, [
      {
        key: `render`,
        value: function () {
          return P.createElement(aT, this.props);
        },
      },
    ])
  );
})(P.Component);
(qw(oT, `displayName`, `ReferenceLine`),
  qw(oT, `defaultProps`, {
    isFront: !1,
    ifOverflow: `discard`,
    xAxisId: 0,
...
function mT(e, t, n) {
  return (
    (t = vT(t)),
    hT(e, _T() ? Reflect.construct(t, n || [], vT(e).constructor) : t.apply(e, n))
  );
}
function hT(e, t) {
...
var wT = function (e) {
    var t = e.x,
      ...
      r = e.xAxis,
      i = e.yAxis,
      a = cw({ x: r.scale, y: i.scale }),
      o = a.apply({ x: t, y: n }, { bandAware: !0 });
    return sC(e, `discard`) && !a.isInRange(o) ? null : o;
  },
  TT = (function (e) {
    function t() {
      ...
      pT(t, [
        {
          ...
          value: function () {
            ...
            var u = l.x,
              ...
              h = uT(
                uT(
                  { clipPath: sC(this.props, `hidden`) ? `url(#${o})` : void 0 },
                  z(this.props, !0),
                ),
                {},
                { cx: u, cy: d },
            ...
            return P.createElement(
              B,
              { className: a(`recharts-reference-dot`, m) },
              t.renderDot(p, h),
              A_.renderCallByParent(this.props, {
                x: u - i,
                y: d - i,
                width: 2 * i,
                height: 2 * i,
...
(xT(TT, `displayName`, `ReferenceDot`),
  xT(TT, `defaultProps`, {
    isFront: !1,
    ifOverflow: `discard`,
    xAxisId: 0,
  ...
  xT(TT, `renderDot`, function (e, t) {
    return P.isValidElement(e)
      ...
      : (0, R.default)(e)
        ...
        : P.createElement(
            Cx,
            sT({}, t, { cx: t.cx, cy: t.cy, className: `recharts-reference-dot-dot` }),
          );
  }));
function ET() {
  return (
...
function NT(e, t, n) {
  return (
    (t = LT(t)),
    PT(e, IT() ? Reflect.construct(t, n || [], LT(e).constructor) : t.apply(e, n))
  );
}
function PT(e, t) {
...
var UT = function (e, t, n, r, i) {
    ...
    return sC(i, `discard`) && (!d.isInRange(f) || !d.isInRange(p)) ? null : aw(f, p);
  },
  WT = (function (e) {
    function t() {
      ...
      MT(t, [
        {
          ...
          value: function () {
            ...
            var m = UT(l, u, d, f, this.props);
            if (!m && !p) return null;
            var h = sC(this.props, `hidden`) ? `url(#${c})` : void 0;
            return P.createElement(
              B,
              { className: a(`recharts-reference-area`, s) },
              t.renderRect(p, kT(kT({ clipPath: h }, z(this.props, !0)), m)),
              A_.renderCallByParent(this.props, m),
            );
          },
        },
      ])
...
(BT(WT, `displayName`, `ReferenceArea`),
  BT(WT, `defaultProps`, {
    isFront: !1,
    ifOverflow: `discard`,
    xAxisId: 0,
  ...
  BT(WT, `renderRect`, function (e, t) {
    return P.isValidElement(e)
      ...
      : (0, R.default)(e)
        ? e(t)
        : P.createElement(xx, ET({}, t, { className: `recharts-reference-area-rect` }));
  }));
function GT(e, t, n) {
  if (t < 1) return [];
...
function KT(e, t, n) {
  return uw({ width: e.width + t.width, height: e.height + t.height }, n);
}
function qT(e, t, n) {
  var r = n === `width`,
    i = e.x,
  ...
  for (
    var a = (r || []).slice(),
      ...
      l = function (t) {
        ...
        JT(e, r.tickCoord, u, s, c) &&
          ((c = r.tickCoord - e * (u() / 2 + i)), (a[t] = $T($T({}, r), {}, { isShow: !0 })));
      },
      u = o - 1;
    u >= 0;
    u--
...
function iE(e, t, n, r, i, a) {
  ...
  if (a) {
    ...
    ((o[s - 1] = u = $T($T({}, u), {}, { tickCoord: f > 0 ? u.coordinate - f * e : u.coordinate })),
      JT(
        e,
        u.tickCoord,
        function () {
        ...
        c,
        l,
      ) && ((l = u.tickCoord - e * (d / 2 + i)), (o[s - 1] = $T($T({}, u), {}, { isShow: !0 }))));
  }
  for (
    var p = a ? s - 1 : s,
      m = function (t) {
        ...
        JT(e, r.tickCoord, s, c, l) &&
          ((c = r.tickCoord + e * (s() / 2 + i)), (o[t] = $T($T({}, r), {}, { isShow: !0 })));
      },
      h = 0;
    h < p;
    h++
...
function aE(e, t, n) {
  ...
  if (I(c) || ns.isSsr) return YT(i, typeof c == `number` && I(c) ? c : 0);
  var f = [],
    p = s === `top` || s === `bottom` ? `width` : `height`,
    m = u && p === `width` ? $s(u, { fontSize: t, letterSpacing: n }) : { width: 0, height: 0 },
    h = function (e, r) {
      var i = (0, R.default)(l) ? l(e.value, r) : e.value;
      return p === `width`
        ? KT($s(i, { fontSize: t, letterSpacing: n }), m, d)
        : $s(i, { fontSize: t, letterSpacing: n })[p];
    },
  ...
  return c === `equidistantPreserveStart`
    ...
    : ((f =
        c === `preserveStart` || c === `preserveStartEnd`
          ? iE(g, _, h, i, o, c === `preserveStartEnd`)
          : rE(g, _, h, i, o)),
      f.filter(function (e) {
        return e.isShow;
      }));
...
function _E(e, t, n) {
  return (
    (t = xE(t)),
    vE(e, bE() ? Reflect.construct(t, n || [], xE(e).constructor) : t.apply(e, n))
  );
}
function vE(e, t) {
        ...
        },
        {
          ...
          value: function () {
            var e = this.props,
              ...
              s = e.mirror,
              c = e.axisLine,
              l = X(X(X({}, z(this.props, !1)), z(c, !1)), {}, { fill: `none` });
            if (o === `top` || o === `bottom`) {
              var u = +((o === `top` && !s) || (o === `bottom` && s));
              l = X(X({}, l), {}, { x1: t, y1: n + u * i, x2: t + r, y2: n + u * i });
            } else {
              var d = +((o === `left` && !s) || (o === `right` && s));
              l = X(X({}, l), {}, { x1: t + d * r, y1: n, x2: t + d * r, y2: n + i });
            }
            return P.createElement(
              `line`,
              uE({}, l, {
                className: a(`recharts-cartesian-axis-line`, (0, Re.default)(c, `className`)),
              }),
            );
          },
        },
        {
          ...
          value: function (e, n, r) {
            var i = this,
              ...
              u = o.tickFormatter,
              d = o.unit,
              f = aE(X(X({}, this.props), {}, { ticks: e }), n, r),
              p = this.getTickTextAnchor(),
              m = this.getTickVerticalAnchor(),
              h = z(this.props, !1),
              g = z(l, !1),
              _ = X(X({}, h), {}, { fill: `none` }, z(s, !1)),
              v = f.map(function (e, n) {
                var r = i.getTickLineCoord(e),
                  ...
                  y = X(
                    X(
                      X(
                        X({ textAnchor: p, verticalAnchor: m }, h),
                        {},
                        { stroke: `none`, fill: c },
                        g,
                      ),
        ...
        },
        {
          ...
          value: function () {
            ...
            var c = this.props,
              ...
              d = l;
            return (
              (0, R.default)(o) && (d = l && l.length > 0 ? o(this.props) : o(u)),
              r <= 0 || i <= 0 || !d || !d.length
                ? null
                : P.createElement(
                    B,
                    {
                      className: a(`recharts-cartesian-axis`, s),
                      ref: function (t) {
                        e.layerReference = t;
                      },
                    },
      ...
      [
        {
          ...
          value: function (e, t, n) {
            var r,
              i = a(t.className, `recharts-cartesian-axis-tick-value`);
            return (
              (r = P.isValidElement(e)
                ? P.cloneElement(e, X(X({}, t), {}, { className: i }))
                : (0, R.default)(e)
                  ? e(X(X({}, t), {}, { className: i }))
                  : P.createElement(
                      Gc,
                      uE({}, t, { className: `recharts-cartesian-axis-tick-value` }),
                      n,
                    )),
              r
            );
...
(wE(DE, `displayName`, `CartesianAxis`),
  wE(DE, `defaultProps`, {
    x: 0,
    y: 0,
    width: 0,
...
function BE(e, t) {
  ...
  if (P.isValidElement(e)) n = P.cloneElement(e, t);
    ...
    c.offset;
    var l = LE(c, kE);
    n = P.createElement(`line`, IE({}, l, { x1: r, y1: i, x2: a, y2: o, fill: `none`, key: s }));
  }
  return n;
}
function VE(e) {
  ...
  var o = a.map(function (r, a) {
    return BE(i, ME(ME({}, e), {}, { x1: t, y1: r, x2: t + n, y2: r, key: `line-${a}`, index: a }));
  });
...
function HE(e) {
  ...
  if (!i || !a || !a.length) return null;
  var o = a.map(function (r, a) {
    return BE(i, ME(ME({}, e), {}, { x1: r, y1: t, x2: r, y2: t + n, key: `line-${a}`, index: a }));
  });
...
var GE = function (e, t) {
    ...
    return wg(
      aE(
        ME(
          ME(ME({}, DE.defaultProps), n),
          {},
          { ticks: Tg(n, !0), viewBox: { x: 0, y: 0, width: r, height: i } },
        ),
      ),
      a.left,
      a.left + a.width,
...
function JE(e) {
  var t = jw(),
    ...
    i = ME(
      ...
      {},
      {
        stroke: e.stroke ?? qE.stroke,
        fill: e.fill ?? qE.fill,
        horizontal: e.horizontal ?? qE.horizontal,
        horizontalFill: e.horizontalFill ?? qE.horizontalFill,
        vertical: e.vertical ?? qE.vertical,
        verticalFill: e.verticalFill ?? qE.verticalFill,
        x: I(e.x) ? e.x : r.left,
        y: I(e.y) ? e.y : r.top,
  ...
  var m = i.verticalCoordinatesGenerator || GE,
    h = i.horizontalCoordinatesGenerator || KE,
  ...
  if ((!g || !g.length) && (0, R.default)(h)) {
    var v = u && u.length,
      y = h(
        {
          yAxis: p ? ME(ME({}, p), {}, { ticks: v ? u : p.ticks }) : void 0,
          width: t,
          height: n,
          offset: r,
        },
    ...
    (`${AE(y)}`, Array.isArray(y) && (g = y));
  }
  if ((!_ || !_.length) && (0, R.default)(m)) {
    var b = d && d.length,
      x = m(
        {
          xAxis: f ? ME(ME({}, f), {}, { ticks: b ? d : f.ticks }) : void 0,
          width: t,
          height: n,
          offset: r,
        },
  ...
  return P.createElement(
    ...
    P.createElement(VE, IE({}, i, { offset: r, horizontalPoints: g, xAxis: f, yAxis: p })),
    P.createElement(HE, IE({}, i, { offset: r, verticalPoints: _, xAxis: f, yAxis: p })),
    P.createElement(UE, IE({}, i, { horizontalPoints: g })),
    P.createElement(WE, IE({}, i, { verticalPoints: _ })),
  );
}
...
function ZE(e, t) {
  for (var n = 0; n < t.length; n++) {
    ...
    ((r.enumerable = r.enumerable || !1),
      (r.configurable = !0),
      `value` in r && (r.writable = !0),
      Object.defineProperty(e, sD(r.key), r));
  }
}
function QE(e, t, n) {
  return (
...
function $E(e, t, n) {
  return (
    (t = rD(t)),
    eD(e, nD() ? Reflect.construct(t, n || [], rD(e).constructor) : t.apply(e, n))
  );
}
function eD(e, t) {
...
function uD(e) {
  ...
  return i == null
    ...
    : P.createElement(
        DE,
        lD({}, i, {
          className: a(`recharts-${i.axisType} ${i.axisType}`, i.className),
...
var dD = (function (e) {
  function t() {
    return (XE(this, t), $E(this, t, arguments));
  }
  return (
    iD(t, e),
    QE(t, [
      {
        key: `render`,
        value: function () {
          return P.createElement(uD, this.props);
        },
      },
    ])
  );
})(P.Component);
(oD(dD, `displayName`, `XAxis`),
  oD(dD, `defaultProps`, {
    allowDecimals: !0,
    hide: !1,
    orientation: `bottom`,
...
function mD(e, t) {
  for (var n = 0; n < t.length; n++) {
    ...
    ((r.enumerable = r.enumerable || !1),
      (r.configurable = !0),
      `value` in r && (r.writable = !0),
      Object.defineProperty(e, wD(r.key), r));
  }
}
function hD(e, t, n) {
  return (
...
function gD(e, t, n) {
  return (
    (t = bD(t)),
    _D(e, yD() ? Reflect.construct(t, n || [], bD(e).constructor) : t.apply(e, n))
  );
}
function _D(e, t) {
  if (t && (fD(t) === `object` || typeof t == `function`)) return t;
  if (t !== void 0) throw TypeError(`Derived constructors may only return object or undefined`);
  return vD(e);
}
function vD(e) {
...
var DD = function (e) {
  ...
  OD = (function (e) {
    function t() {
      return (pD(this, t), gD(this, t, arguments));
    }
    return (
      xD(t, e),
      hD(t, [
        {
          key: `render`,
          value: function () {
            return P.createElement(DD, this.props);
          },
        },
      ])
    );
  })(P.Component);
(CD(OD, `displayName`, `YAxis`),
  CD(OD, `defaultProps`, {
    allowDuplicatedCategory: !0,
    allowDecimals: !0,
    hide: !1,
...
function jD(e, t) {
  if (e) {
    ...
    if ((n === `Object` && e.constructor && (n = e.constructor.name), n === `Map` || n === `Set`))
      return Array.from(e);
    if (n === `Arguments` || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return PD(e, t);
  }
}
function MD(e) {
  if ((typeof Symbol < `u` && e[Symbol.iterator] != null) || e[`@@iterator`] != null)
    ...
    if (
      (s.length &&
        (d = s.reduce(function (e, t) {
          if (t.props[l] === n && sC(t.props, `extendDomain`) && I(t.props[u])) {
            var r = t.props[u];
      ...
      d = c.reduce(function (e, t) {
        if (t.props[l] === n && sC(t.props, `extendDomain`) && I(t.props[f]) && I(t.props[p])) {
          var r = t.props[f],
            i = t.props[p];
...
var GD = (function () {
  function e() {
    (zD(this, e),
      HD(this, `activeIndex`, 0),
      HD(this, `coordinateList`, []),
      HD(this, `layout`, `horizontal`));
  }
  return VD(e, [
    {
      key: `setDetails`,
...
function nO(e) {
  ...
  var p,
    m = Dv;
  if (d === `ScatterChart`) ((p = i), (m = Fx));
  else if (d === `BarChart`) ((p = qD(u, i, s, l)), (m = xx));
  else if (u === `radial`) {
    var h = JD(i),
      g = h.cx,
      _ = h.cy,
    ...
    ((p = {
      ...
      (m = pv));
  } else ((p = { points: YD(u, i, s) }), (m = Dv));
  var y = QD(
    QD(QD(QD({ stroke: `#ccc`, pointerEvents: `none` }, s), p), z(f, !1)),
    {},
    { payload: o, payloadIndex: c, className: a(`recharts-tooltip-cursor`, f.className) },
  );
  return (0, P.isValidElement)(f) ? (0, P.cloneElement)(f, y) : (0, P.createElement)(m, y);
}
var rO = [`item`],
  iO = [`children`, `className`, `width`, `height`, `style`, `compact`, `title`, `desc`];
function aO(e) {
  "@babel/helpers - typeof";
  return (
    (aO =
...
function gO(e, t, n) {
  return (
    (t = bO(t)),
    _O(e, yO() ? Reflect.construct(t, n || [], bO(e).constructor) : t.apply(e, n))
  );
}
function _O(e, t) {
...
var MO = { xAxis: [`bottom`, `top`], yAxis: [`left`, `right`] },
  ...
  LO = function (e, t, n, r) {
    ...
    if (i) {
      ...
      if (e === `centric`) {
        var a = i.coordinate,
          o = r.radius;
        return Z(Z(Z({}, r), r_(r.cx, r.cy, o, a)), {}, { angle: a, radius: o });
      }
      var s = i.coordinate,
        c = r.angle;
      return Z(Z(Z({}, r), r_(r.cx, r.cy, s, c)), {}, { angle: c, radius: s });
    }
    return PO;
  },
  RO = function (e, t) {
...
var BO = function (e, t, n, r) {
  ...
  VO = function (e, t, n, r) {
    ...
    if (l >= 0 && c) {
      ...
      return {
        ...
        activeLabel: u,
        activePayload: BO(e, t, l, u),
        activeCoordinate: LO(n, o, l, i),
      };
    }
    return null;
  },
  HO = function (e, t) {
    ...
    return n.reduce(function (t, n) {
      var p = n.type.defaultProps === void 0 ? n.props : Z(Z({}, n.type.defaultProps), n.props),
        m = p.type,
        h = p.dataKey,
      ...
      var S = RO(e.data, {
        ...
        E;
      KD(p.domain, g, m) &&
        ((w = Gg(p.domain, null, g)),
        f && (m === `number` || v !== `auto`) && (E = pg(S, h, `category`)));
      var D = zO(m);
      if (!w || w.length === 0) {
        var O = p.domain ?? D;
        if (h) {
          if (((w = pg(S, h, m)), m === `category` && f)) {
            var k = qe(w);
            _ && k
              ? ((T = w), (w = (0, AS.default)(0, C)))
              : _ ||
                (w = qg(O, w, n).reduce(function (e, t) {
        ...
        if (m === `number`) ((w = FD(u, w, x, i, y)), O && (w = Gg(O, w, g)));
  ...
  UO = function (e, t) {
    var n = t.graphicalItems,
      ...
      l = e.layout,
      u = e.children,
      d = RO(e.data, { graphicalItems: n, dataStartIndex: s, dataEndIndex: c }),
      f = d.length,
      p = Cg(l, i),
      m = -1;
    return n.reduce(function (e, t) {
      var h = (t.type.defaultProps === void 0 ? t.props : Z(Z({}, t.type.defaultProps), t.props))[
          a
        ],
        g = zO(`number`);
      if (!e[h]) {
        ...
        return (
          p
            ? (_ = (0, AS.default)(0, f))
            : o && o[h] && o[h].hasStack
              ? ((_ = Hg(o[h].stackGroups, s, c)), (_ = FD(u, _, h, i)))
              : ((_ = Gg(
                  g,
                  Sg(
                    d,
          ...
          Z(
            ...
            Q(
              ...
              Z(
                ...
                {
                  hide: !0,
                  orientation: (0, Re.default)(MO, `${i}.${m % 2}`, null),
                  domain: _,
                  originalDomain: g,
                  isCategorical: p,
                  layout: l,
  ...
  GO = function (e) {
    ...
    return {
      tooltipTicks: n,
      orderedTooltipTicks: (0, fo.default)(n, function (e) {
        return e.coordinate;
      }),
      tooltipAxis: t,
      tooltipAxisBandSize: Kg(t, n),
    };
  },
  KO = function (e) {
    var t = e.children,
  ...
  YO = function (e, t) {
    var n = e.props,
          ...
          Object.keys(a).reduce(
            function (e, t) {
              ...
              return !n.mirror && !n.hide
                ? Z(Z({}, e), {}, Q({}, r, (0, Re.default)(e, `${r}`) + n.height))
                : e;
            },
      ...
      g = h.bottom;
    (f && (h.bottom += f.props.height || iC.defaultProps.height), p && t && (h = vg(h, r, n, t)));
  ...
  ZO = function (e) {
    var t = e.chartName,
      ...
      f = function (e, t) {
        ...
        return (
          n.forEach(function (n, m) {
            var y = RO(e.data, { graphicalItems: [n], dataStartIndex: o, dataEndIndex: s }),
              b = n.type.defaultProps === void 0 ? n.props : Z(Z({}, n.type.defaultProps), n.props),
              x = b.dataKey,
              S = b.maxBarSize,
              C = b[`${h}Id`],
              w = b[`${g}Id`],
              T = c.reduce(function (e, n) {
                ...
                var a = r[i];
                return Z(Z({}, e), {}, Q(Q({}, n.axisType, a), `${n.axisType}Ticks`, Tg(a)));
              }, {}),
              E = T[g],
              D = T[`${g}Ticks`],
              O = r && r[C] && r[C].hasStack && Bg(n, r[C].stackGroups),
              k = ht(n.type).indexOf(`Bar`) >= 0,
              A = Kg(E, D),
              j = [],
              M = _ && gg({ barSize: l, stackGroups: r, totalSize: XO(T, g) });
            if (k) {
                ...
                ee !== A &&
                  (j = j.map(function (e) {
                    return Z(
                      ...
                      {},
                      {
                        position: Z(Z({}, e.position), {}, { offset: e.position.offset - ee / 2 }),
                      },
                    );
                  })));
            }
      ...
      p = function (e, r) {
        ...
        var l = i.children,
          ...
          S = YO(Z(Z({}, x), {}, { props: i, graphicalItems: y }), r?.legendBBox);
      ...
      m = (function (e) {
        function n(e) {
          ...
          return (
            pO(this, n),
            (r = gO(this, n, [e])),
            Q(r, `eventEmitterSymbol`, Symbol(`rechartsEventEmitter`)),
            Q(r, `accessibilityManager`, new GD()),
            Q(r, `handleLegendBBoxUpdate`, function (e) {
              if (e) {
                var t = r.state,
                  n = t.dataStartIndex,
                  i = t.dataEndIndex,
            ...
            Q(r, `handleReceiveSyncEvent`, function (e, t, n) {
              if (r.props.syncId === e) {
                if (n === r.eventEmitterSymbol && typeof r.props.syncMethod != `function`) return;
                r.applySyncEvent(t);
              }
            }),
            Q(r, `handleBrushChange`, function (e) {
              var t = e.startIndex,
                n = e.endIndex;
            ...
            Q(r, `handleMouseEnter`, function (e) {
            ...
            Q(r, `triggeredAfterMouseMove`, function (e) {
              var t = r.getMouseInfo(e),
            ...
            Q(r, `handleItemMouseEnter`, function (e) {
              r.setState(function () {
                return {
                  isTooltipActive: !0,
                  activeItem: e,
            ...
            Q(r, `handleItemMouseLeave`, function () {
              r.setState(function () {
                return { isTooltipActive: !1 };
              });
            }),
            Q(r, `handleMouseMove`, function (e) {
              (e.persist(), r.throttleTriggeredAfterMouseMove(e));
            }),
            Q(r, `handleMouseLeave`, function (e) {
            ...
            Q(r, `handleOuterEvent`, function (e) {
              var t = kt(e),
            ...
            Q(r, `handleMouseDown`, function (e) {
              var t = r.props.onMouseDown;
              (0, R.default)(t) && t(r.getMouseInfo(e), e);
            }),
            Q(r, `handleMouseUp`, function (e) {
              var t = r.props.onMouseUp;
              (0, R.default)(t) && t(r.getMouseInfo(e), e);
            }),
            Q(r, `handleTouchMove`, function (e) {
              e.changedTouches != null &&
                e.changedTouches.length > 0 &&
                r.throttleTriggeredAfterMouseMove(e.changedTouches[0]);
            }),
            Q(r, `handleTouchStart`, function (e) {
              e.changedTouches != null &&
                e.changedTouches.length > 0 &&
                r.handleMouseDown(e.changedTouches[0]);
            }),
            Q(r, `handleTouchEnd`, function (e) {
              e.changedTouches != null &&
                e.changedTouches.length > 0 &&
                r.handleMouseUp(e.changedTouches[0]);
            }),
            Q(r, `handleDoubleClick`, function (e) {
              var t = r.props.onDoubleClick;
              (0, R.default)(t) && t(r.getMouseInfo(e), e);
            }),
            Q(r, `handleContextMenu`, function (e) {
              var t = r.props.onContextMenu;
              (0, R.default)(t) && t(r.getMouseInfo(e), e);
            }),
            Q(r, `triggerSyncEvent`, function (e) {
              r.props.syncId !== void 0 && ID.emit(LD, r.props.syncId, e, r.eventEmitterSymbol);
            }),
            Q(r, `applySyncEvent`, function (e) {
              var t = r.props,
                n = t.layout,
                i = t.syncMethod,
                a = r.state.updateId,
            ...
            Q(r, `renderPolarAxis`, function (e, t, n) {
              var i = (0, Re.default)(e, `type.axisType`),
                o = (0, Re.default)(r.state, `${i}Map`),
                s = e.type.defaultProps,
                c = s === void 0 ? e.props : Z(Z({}, s), e.props),
                l = o && o[c[`${i}Id`]];
              return (0, P.cloneElement)(
                e,
                Z(
                  Z({}, l),
                  {},
                  { className: a(i, l.className), key: e.key || `${t}-${n}`, ticks: Tg(l, !0) },
                ),
              );
            }),
            Q(r, `renderPolarGrid`, function (e) {
              var t = e.props,
                n = t.radialLines,
                i = t.polarAngles,
                a = t.polarRadius,
              ...
              return (0, P.cloneElement)(e, {
                polarAngles: Array.isArray(i)
                  ? i
                  : Tg(u, !0).map(function (e) {
                      return e.coordinate;
                    }),
                polarRadius: Array.isArray(a)
                  ? a
                  : Tg(l, !0).map(function (e) {
                      return e.coordinate;
                    }),
                cx: d,
                cy: f,
            ...
            Q(r, `renderBrush`, function (e) {
              ...
              return (0, P.cloneElement)(e, {
                ...
                onChange: Dg(r.handleBrushChange, e.props.onChange),
                data: i,
            ...
            Q(r, `renderReferenceElement`, function (e, t, n) {
              if (!e) return null;
              var i = r.clipPathId,
                a = r.state,
                o = a.xAxisMap,
            ...
            Q(r, `renderActivePoints`, function (e) {
              var t = e.item,
                r = e.activePoint,
                i = e.basePoint,
                a = e.childIndex,
                ...
                l =
                  t.item.type.defaultProps === void 0
                    ? t.item.props
                    : Z(Z({}, t.item.type.defaultProps), t.item.props),
                u = l.activeDot,
                d = l.dataKey,
                f = Z(
                  Z(
            ...
            Q(r, `renderGraphicChild`, function (e, t, n) {
              ...
              var a = r.getTooltipEventType(),
                ...
                _ =
                  i.item.type.defaultProps === void 0
                    ? i.item.props
                    : Z(Z({}, i.item.type.defaultProps), i.item.props),
                v = _.activeDot,
                y = _.hide,
                b = _.activeBar,
                x = _.activeShape,
              ...
              a !== `axis` && f && f.props.trigger === `click`
                ? (C = { onClick: Dg(r.handleItemMouseEnter, e.props.onClick) })
                : a !== `axis` &&
                  (C = {
                    onMouseLeave: Dg(r.handleItemMouseLeave, e.props.onMouseLeave),
                    onMouseEnter: Dg(r.handleItemMouseEnter, e.props.onMouseEnter),
                  });
              var w = (0, P.cloneElement)(e, Z(Z({}, i.props), C));
              function T(e) {
              ...
              if (S)
                if (l >= 0) {
                  ...
                  if (x || b) {
                    ...
                    return [
                      (0, P.cloneElement)(e, Z(Z(Z({}, i.props), C), {}, { activeIndex: k })),
                      null,
                      null,
                    ];
                  }
                  ...
                  var A = (r.getItemByXY(r.state.activeCoordinate) ?? { graphicalItem: w })
                    ...
                    N = A.childIndex;
                  return [
                    (0, P.cloneElement)(M, Z(Z(Z({}, i.props), C), {}, { activeIndex: N })),
                    null,
                    null,
                  ];
                }
            ...
            Q(r, `renderCustomized`, function (e, t, n) {
              return (0, P.cloneElement)(
                e,
            ...
            Q(r, `renderMap`, {
              CartesianGrid: { handler: FO, once: !0 },
              ReferenceArea: { handler: r.renderReferenceElement },
              ReferenceLine: { handler: FO },
            ...
            (r.throttleTriggeredAfterMouseMove = (0, Ds.default)(
        ...
        return (
          ...
          hO(n, [
            ...
            },
            {
              key: `componentDidUpdate`,
              value: function (e) {
                Et([bt(e.children, xs)], [bt(this.props.children, xs)]) ||
                  this.displayDefaultTooltip();
              },
            },
            {
            ...
            },
            {
              ...
              value: function (e) {
                ...
                var s = this.state,
                  ...
                  d = VO(this.state, this.props.data, this.props.layout, o);
                if (u !== `axis` && c && l) {
                  var f = Ke(c).scale,
                    p = Ke(l).scale,
                    m = f && f.invert ? f.invert(i.chartX) : null,
                    h = p && p.invert ? p.invert(i.chartY) : null;
                  return Z(Z({}, i), {}, { xValue: m, yValue: h }, d);
                }
                return d ? Z(Z({}, i), d) : null;
              },
            },
            {
              key: `inRange`,
            ...
            },
            {
              ...
              value: function () {
                ...
                return (
                  ...
                  Z(Z({}, ot(this.props, this.handleOuterEvent)), r)
                );
              },
            },
            {
              key: `addListener`,
              value: function () {
                ID.on(LD, this.handleReceiveSyncEvent);
              },
            },
            {
              key: `removeListener`,
              value: function () {
                ID.removeListener(LD, this.handleReceiveSyncEvent);
              },
            },
            {
              ...
              value: function (e) {
                ...
                if (n && n.length)
                  for (var i = 0, a = n.length; i < a; i++) {
                    ...
                    } else if (_S(o, r) || vS(o, r) || yS(o, r)) {
                      var p = ES({ graphicalItem: o, activeTooltipItem: r, itemData: l.data }),
                        m = l.activeIndex === void 0 ? p : l.activeIndex;
                      return {
                        graphicalItem: Z(Z({}, o), {}, { childIndex: m }),
                        payload: yS(o, r) ? l.data[p] : o.props.data[p],
                      };
                    }
                  }
                return null;
              ...
              value: function () {
                ...
                if (c)
                  return P.createElement(
                    ...
                    P.createElement(
                      Ft,
                      oO({}, d, { width: i, height: o, title: l, desc: u }),
                      this.renderClipPath(),
                      Ot(n, this.renderMap),
                    ),
                  );
                ...
                return P.createElement(
                  ...
                  P.createElement(
                    ...
                    oO(
                      {
                        ...
                        style: Z(
                          { position: `relative`, cursor: `default`, width: i, height: o },
                          s,
                        ),
                      },
                      f,
                    ...
                    P.createElement(
                      Ft,
                      oO({}, d, { width: i, height: o, title: l, desc: u, style: NO }),
                      this.renderClipPath(),
                      Ot(n, this.renderMap),
                    ),
                    this.renderLegend(),
    ...
    (Q(m, `displayName`, t),
      ...
      Q(m, `getDerivedStateFromProps`, function (e, t) {
        var n = e.dataKey,
          r = e.data,
          i = e.children,
          a = e.width,
        ...
        if (
          ...
          var m = KO(e),
            ...
            g = Z(Z({}, VO(t, r, s)), {}, { updateId: t.updateId + 1 }),
            _ = Z(Z(Z({}, m), h), g);
          return Z(
  ...
  tk = 3600 * 24;
(tk * 7, ((tk * QO) / 12) * 3);
var nk = Symbol.for(`constructDateFrom`);
function rk(e, t) {
  return typeof e == `function`
    ? e(t)
    : e && typeof e == `object` && nk in e
      ? e[nk](t)
      : e instanceof Date
        ? new e.constructor(t)
        : new Date(t);
...
function ak(e, t, n) {
  let r = ik(e, n?.in);
  return isNaN(t) ? rk(n?.in || e, NaN) : (t && r.setDate(r.getDate() + t), r);
}
function ok(e, ...t) {
  let n = rk.bind(null, e || t.find((e) => typeof e == `object`));
  return t.map(n);
}
function sk(e, t) {
  let n = ik(e, t?.in);
...
function ck(e, t) {
  let [n, r] = ok(e, t.start, t.end);
  return { start: n, end: r };
}
function lk(e, t) {
  let { start: n, end: r } = ck(t?.in, e),
    i = +n > +r,
    a = i ? +n : +r,
    o = i ? r : n;
  o.setHours(0, 0, 0, 0);
  ...
  s < 0 && ((s = -s), (i = !i));
  let c = [];
  for (; +o <= a;) (c.push(rk(n, o)), o.setDate(o.getDate() + s), o.setHours(0, 0, 0, 0));
  return i ? c.reverse() : c;
}
function uk(e, t, n) {
  return ak(e, -t, n);
}
var dk = (e) => e.price_at_sale * e.quantity,
  fk = (e) => (e.price_at_sale - (e.cost_at_sale ?? 0)) * e.quantity,
  pk = (e) => e.category_at_sale ?? `Autre`,
  mk = (e) => sk(e).getTime();
function hk(e) {
  let t = sk(new Date());
  return { from: uk(t, e - 1).getTime(), to: t.getTime() + 864e5 };
}
function gk(e, t, n, r) {
  let i = e.filter((e) => e.timestamp >= n && e.timestamp < r),
    a = new Set(i.map((e) => e.id)),
    o = t.filter((e) => a.has(e.sale_id)),
    s = new Map(i.map((e) => [e.id, mk(e.timestamp)])),
    c = new Map();
  for (let e of lk({ start: n, end: r - 1 }))
    c.set(e.getTime(), { day: e.getTime(), revenue: 0, profit: 0, salesCount: 0 });
  for (let e of i) {
    let t = c.get(mk(e.timestamp));
    t && (t.salesCount += 1);
  }
  let l = new Map(),
    u = 0,
  ...
  for (let e of o) {
    let t = dk(e),
      n = fk(e);
    ((u += t), (d += n), (f += e.quantity));
    let r = s.get(e.sale_id),
      i = r === void 0 ? void 0 : c.get(r);
    i && ((i.revenue += t), (i.profit += n));
    let a = pk(e),
      o = l.get(a);
    o ? ((o.revenue += t), (o.profit += n)) : l.set(a, { category: a, revenue: t, profit: n });
  }
  let p = Array.from(c.values()).sort((e, t) => e.day - t.day),
    m = p.filter((e) => e.salesCount > 0);
  return {
    revenue: u,
    profit: d,
    salesCount: i.length,
    itemsCount: f,
    marginRate: u > 0 ? d / u : 0,
    averageBasket: i.length > 0 ? u / i.length : 0,
    bestDay: m.reduce((e, t) => (!e || t.revenue > e.revenue ? t : e), null),
    worstDay: m.reduce((e, t) => (!e || t.profit < e.profit ? t : e), null),
    growthRate: _k(p),
    byCategory: Array.from(l.values()).sort((e, t) => t.revenue - e.revenue),
    days: p,
  };
}
function _k(e) {
  ...
  let t = Math.floor(e.length / 2),
    n = e.slice(0, t).reduce((e, t) => e + t.revenue, 0),
    r = e.slice(e.length - t).reduce((e, t) => e + t.revenue, 0);
  return n === 0 ? NaN : (r - n) / n;
}
function vk(e, t) {
  return d({
    queryKey: [`sales`, `range`, e, t],
    queryFn: async () => {
      let n = await c(e, t);
      return { sales: n, items: await s(n.map((e) => e.id)) };
    },
  });
}
var $ = r();
function yk({ label: e, value: t, hint: n, highlight: r }) {
  return (0, $.jsx)(u, {
    children: (0, $.jsxs)(l, {
      className: `p-4`,
      children: [
        (0, $.jsx)(`div`, { className: `text-sm text-muted-foreground`, children: e }),
        (0, $.jsx)(`div`, {
          className: `mt-1 text-2xl font-bold ` + (r ? `text-primary` : `text-foreground`),
          children: t,
        }),
        n && (0, $.jsx)(`div`, { className: `mt-1 text-xs text-muted-foreground`, children: n }),
      ],
    }),
  });
}
var bk = { light: ``, dark: `.dark` },
  xk = P.createContext(null);
function Sk() {
  let e = P.useContext(xk);
  if (!e) throw Error(`useChart must be used within a <ChartContainer />`);
  return e;
}
var Ck = P.forwardRef(({ id: e, className: t, children: n, config: r, ...i }, a) => {
  let s = P.useId(),
    c = `chart-${e || s.replace(/:/g, ``)}`;
  return (0, $.jsx)(xk.Provider, {
    value: { config: r },
    children: (0, $.jsxs)(`div`, {
      "data-chart": c,
      ref: a,
      ...
      ...i,
      children: [(0, $.jsx)(wk, { id: c, config: r }), (0, $.jsx)(Bs, { children: n })],
    }),
  });
});
Ck.displayName = `Chart`;
var wk = ({ id: e, config: t }) => {
    let n = Object.entries(t).filter(([, e]) => e.theme || e.color);
    return n.length
      ? (0, $.jsx)(`style`, {
          dangerouslySetInnerHTML: {
            __html: Object.entries(bk).map(
              ([t, r]) => `
${r} [data-chart=${e}] {
${n.map(([e, n]) => {
      ...
      let { config: h } = Sk(),
        g = P.useMemo(() => {
          ...
          let [e] = t,
            ...
            r = Ok(h, e, n),
            a = !p && typeof s == `string` ? h[s]?.label || s : r?.label;
          return c
            ? (0, $.jsx)(`div`, { className: o(`font-medium`, l), children: c(a, t) })
            : a
              ? (0, $.jsx)(`div`, { className: o(`font-medium`, l), children: a })
              : null;
        }, [s, c, t, i, l, h, p]);
                              ...
                              i?.icon
                                ...
                                : !a &&
                                  (0, $.jsx)(`div`, {
                                    ...
                                    style: { "--color-bg": s, "--color-border": s },
                                  }),
                              (0, $.jsxs)(`div`, {
                                className: o(
...
Ek.displayName = `ChartTooltip`;
var Dk = P.forwardRef(
  ({ className: e, hideIcon: t = !1, payload: n, verticalAlign: r = `bottom`, nameKey: i }, a) => {
    let { config: s } = Sk();
    return n?.length
      ? (0, $.jsx)(`div`, {
          ref: a,
          className: o(`flex items-center justify-center gap-4`, r === `top` ? `pb-3` : `pt-3`, e),
          children: n
            .filter((e) => e.type !== `none`)
            .map((e) => {
...
Dk.displayName = `ChartLegend`;
function Ok(e, t, n) {
  if (typeof t != `object` || !t) return;
  let r = `payload` in t && typeof t.payload == `object` && t.payload !== null ? t.payload : void 0,
    i = n;
  return (
